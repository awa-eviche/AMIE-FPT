<div>
                        ...
                        <tr class="text-gray-700 ">
                            <?php $__empty_1 = true; $__currentLoopData = $metiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                             <td class="p-2 border-b text-gray-500 ">
                                <?php echo e($metier->nom ?? ' - '); ?>

                            </td>
                             
                            <td class="p-2 border-b text-gray-500 ">
                                <?php echo e($metier->filiereName ?? ' - '); ?>

                            </td>
                            <td class="p-2 border-b text-gray-500 ">
                                <?php echo e($metier->secteurName ?? ' - '); ?>
    ...
    <?php echo e($metiers->links()); ?>

</div>
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/dfpt/metier.blade.php ENDPATH**/ ?>