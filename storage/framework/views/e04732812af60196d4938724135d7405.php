                  ...
                  <tr class="text-xs font-bold font-black tracking-wide text-left text-maquette-gris uppercase border-b bg-first-orange ">
                    ...
                    <tbody>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="bg-white">
                                <td class="px-4 py-4 font-bold"><?php echo e($file->libelle); ?></td>
                                <td class="px-4 py-4 font-bold"><?php echo e(date('d/m/Y',strtotime($file->created_at))); ?></td>
                                <td class="px-4 py-4 font-bold flex justify-evenly items-center">
                                    
                                    <a href="<?php echo e(route('show.category', $file->id)); ?>">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/CategoryFile/file/list-file.blade.php ENDPATH**/ ?>