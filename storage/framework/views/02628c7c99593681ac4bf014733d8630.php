<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('index.suscribers')); ?>" class="mx-2 px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512" fill="white">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path d="M144 0a80 80 0 1 1 0 160A80 80 0 1 1 144 0zM512 0a80 80 0 1 1 0 160A80 80 0 1 1 512 0zM0 298.7C0 239.8 47.8 192 106.7 192h42.7c15.9 0 31 3.5 44.6 9.7c-1.3 7.2-1.9 14.7-1.9 22.3c0 38.2 16.8 72.5 43.3 96c-.2 0-.4 0-.7 0H21.3C9.6 320 0 310.4 0 298.7zM405.3 320c-.2 0-.4 0-.7 0c26.6-23.5 43.3-57.8 43.3-96c0-7.6-.7-15-1.9-22.3c13.6-6.3 28.7-9.7 44.6-9.7h42.7C592.2 192 640 239.8 640 298.7c0 11.8-9.6 21.3-21.3 21.3H405.3zM224 224a96 96 0 1 1 192 0 96 96 0 1 1 -192 0zM128 485.3C128 411.7 187.7 352 261.3 352H378.7C452.3 352 512 411.7 512 485.3c0 14.7-11.9 26.7-26.7 26.7H154.7c-14.7 0-26.7-11.9-26.7-26.7z"/></svg>
                <span class="mx-2">Voir les abonnés</span>
            </a>
            <a href="<?php echo e(route('create.newsletters')); ?>" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                </svg><span class="mx-2">Nouvelle newsletter</span>
            </a>
        </div>
    </div>
            ...
            <table class="w-full border-t mb-3">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-4">Envoyé</th>
                        <th class="px-4 py-4">Date d'envoi</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $newsletters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsletter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3 border-b">
                                <?php echo e($newsletter->newsletter_object ?? ' - '); ?>

                            </td>
                            <td class="px-4 py-3 border-b  font-bold"><span class="text-center px-2 py-1 <?php echo e(($newsletter->newsletter_is_sent == 0) ? 'text-red-600 bg-red-100' : 'text-green-600 bg-green-100'); ?>"><?php echo e($newsletter->newsletter_is_sent ? 'OUI' : 'NON'); ?></span></td>
                            <td class="px-4 py-3 border-b text-maquette-gris"><?php echo e(date('d-m-Y',strtotime($newsletter->created_at)) ?? '-'); ?></td>
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                    ...
                                    <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                        <div class="border shadow-md py-2 text-center">
                                            <a href="<?php echo e(route('edit.newsletters', $newsletter->id)); ?>" class="text-purple-600">
                                                Modifier
                                            </a>
                                        </div>
                                        <div class="border shadow-md py-2 text-center">
                                            <form class="text-center"
                                                action="<?php echo e(route('destroy.newsletters', $newsletter->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/front/admin/newsletters.blade.php ENDPATH**/ ?>