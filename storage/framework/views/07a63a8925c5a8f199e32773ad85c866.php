    ...
    <div class="w-full mx-auto">
        <form wire:submit.prevent class="bg-white rounded px-4 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4 max-w-md mx-auto">
                ...
                <?php $__errorArgs = ['donnees.libelle'];
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/demandes/edit-demande.blade.php ENDPATH**/ ?>