    ...
    <script>
        function app() {
            return {
                ...
                validNextStep(step) {
                    const regex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
                    inp1 = ['nom', 'prenom', 'date_naissance', 'lieu_naissance', 'commune_id', 'adresse', 'sexe']
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/apprenant/createFAOLD.blade.php ENDPATH**/ ?>