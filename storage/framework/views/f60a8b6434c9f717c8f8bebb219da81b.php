...
<?php foreach($attributes->onlyProps(['team', 'component' => 'dropdown-link']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['team', 'component' => 'dropdown-link']); ?>
<?php foreach (array_filter((['team', 'component' => 'dropdown-link']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/components/switchable-team.blade.php ENDPATH**/ ?>