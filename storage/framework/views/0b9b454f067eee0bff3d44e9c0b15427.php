...
$__html = app('livewire')->mount($__name, $__params, 'lw--1073900764-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw--1073900764-1', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="grid md:grid-cols-1 md:gap-6 pt-2">
            <div class="mb-4">
                ...
                <select wire:model="selectedClasseAnnee" name="selectedClasseAnnee" wire:change="$refresh"
                    ...
                    <?php $__currentLoopData = $annees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academiques): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="w-full bg-transparent rounded-lg shadow-xs p-0 flex flex-wrap items-center">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $indicateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indicateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="rounded-lg shadow-md p-4 bg-white2">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex justify-between items-center mt-3">
                        ...
                        <?php if((auth()->user()->personnel && auth()->user()->personnel->etablissement_id) && (\Carbon\Carbon::now()->lt($indicateur->date_echeance) )): ?>
                                        ...
                                        <div class="text-sm w-full overflow-x-scroll p-0">
                                            <table class="w-full border-t mb-3">
                                                ...
                                                <tbody class="bg-white divide-y ">
                                                    <?php $__empty_2 = true; $__currentLoopData = $realisations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $realisation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    ...
                                                    <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                                        <div class="mb-4">
                                                            ...
                                                            <select id="typeindicateur_id"
                                                                ...
                                                                <?php $__currentLoopData = $typeIndicateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <?php $__errorArgs = ['annee_academiques_id '];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                                    ...
                                                                    <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                                                        ...
                                                                        <div class="mb-4">
                                                                            ...
                                                                            <?php $__errorArgs = ['valeurAtteinte'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/indicateur/liste-indicateur.blade.php ENDPATH**/ ?>