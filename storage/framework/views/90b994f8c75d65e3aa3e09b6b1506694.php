<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('create.actualite')); ?>" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    </svg><span class="mx-2">Nouvelle actualité</span>
            </a>
        </div>
    </div>
            ...
            <table class="w-full border-t mb-3">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-4 text-center">Titre</th>
                        <th class="px-4 py-4 text-center">Statut</th>
                        <th class="px-4 py-4 text-center">Date de création</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $actualites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actualite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3 border-b">
                                <a target="_blank" href="<?php echo e(asset('storage/front/actualites/'. $actualite->actualite_main_pic)); ?>"><img class="thumbnail-slider" src="<?php echo e(asset('storage/front/actualites/'. $actualite->actualite_main_pic)); ?>" alt="avatar" /></a>
                            </td>
                            <td class="px-4 py-3 border-b text-maquette-gris">
                                <?php echo e($actualite->actualite_titre ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b  font-bold"><span class="text-center px-2 py-1 <?php echo e(($actualite->actualite_is_active == 0) ? 'text-red-600 bg-red-100' : 'text-green-600	bg-green-100'); ?>"><?php echo e($actualite->actualite_is_active ? 'Publié' : 'Dépublié'); ?></span></td>

                            <td class="px-4 py-3 border-b text-maquette-gris"><?php echo e(date('d-m-Y',strtotime($actualite->created_at)) ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="<?php echo e(route('publier.actualite', $actualite->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('POST'); ?>
                                                    <button title="Supprimer" type="submit" class="text-purple-600">
                                                        <?php echo e($actualite->actualite_is_active == true ? "Dépublier" : "Publier"); ?>

                                                    </button>
                                                </form>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('edit.actualite', $actualite->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="<?php echo e(route('destroy.actualite', $actualite->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/front/actualites.blade.php ENDPATH**/ ?>