...
<body>
      ...
      <div class="map-container" id="mapContainer">
        ...
        <map name="carte_senegal">
          <?php $__currentLoopData = $departements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <area
              alt="<?php echo e($departement->nom_depart); ?>"
              title="<?php echo e($departement->nom_depart); ?>"
              href="#"
  ...
  <script>
    ...
    <?php $__currentLoopData = $departements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      establishments[<?php echo json_encode($d->nom_depart, 15, 512) ?>] = <?php echo json_encode($d->efpts->pluck('nom')->values(), 15, 512) ?>;

      departments[<?php echo json_encode($d->id, 15, 512) ?>] = {
        id: <?php echo json_encode($d->id, 15, 512) ?>,
        name: <?php echo json_encode($d->nom_depart, 15, 512) ?>,
        efpts: [
          <?php $__currentLoopData = $d->efpts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
              id: <?php echo json_encode($e->id, 15, 512) ?>,
              nom: <?php echo json_encode($e->nom, 15, 512) ?>,
              tel: <?php echo json_encode($e->tel, 15, 512) ?>,
              adresse: <?php echo json_encode($e->adresse, 15, 512) ?>,
              programms: [
                <?php $__currentLoopData = $e->programms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  { nom: <?php echo json_encode($p->nom, 15, 512) ?>, grade: <?php echo json_encode(optional($p->grade)->nom, 15, 512) ?> },
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ]
            },
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/criteres/carto.blade.php ENDPATH**/ ?>