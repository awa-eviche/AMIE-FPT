...
<div id="editAbsenceModal" class="hidden fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center z-50">
    ...
    <?php if($evaluation): ?>
        ...
        <?php if($user->hasRole('superadmin') || $user->hasRole('chef_de_travaux') || $user->hasRole('directeur_etude') || $user->hasRole('chef_etablissement')): ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/inscription/liste-inscription.blade.php ENDPATH**/ ?>