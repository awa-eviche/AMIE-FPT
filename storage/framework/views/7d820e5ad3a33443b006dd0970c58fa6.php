...
<div class="mb-4 mx-auto w-full">
    ...
    <div class="mb-4 mx-auto w-full">
        ...
        <select id="element" name="element[]" multiple required
                class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline enlever_shadow">
            <?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/param/create-critere.blade.php ENDPATH**/ ?>