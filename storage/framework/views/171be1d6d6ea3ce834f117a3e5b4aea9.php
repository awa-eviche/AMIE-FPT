...
<?php unset($__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1); ?>
<?php endif; ?>
 <?php $__errorArgs = ['nom_etablissement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php unset($__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1); ?>
<?php endif; ?>
 <?php $__errorArgs = ['email_etablissement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
 ...
 <?php $__errorArgs = ['selectedRegion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
 ...
 <?php $__errorArgs = ['selectedDepartemant'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
 ...
 <?php if(($typeDemande)->code == config('constants.requests.D-OUVERTURE-ETABLISSEMENT') || ($typeDemande)->code == config('constants.requests.D-RECONNAISSANCE') || ($typeDemande)->code == config('constants.requests.D-EXTENSION-FILIERE')): ?>
 <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw--1830525029-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw--1830525029-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw--1830525029-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw--1830525029-3', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw--1830525029-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw--1830525029-5', $__slots ?? [], get_defined_vars());
...
?>
 ...
 <?php $__currentLoopData = $typeDemande->listes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $typeDocument): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 <div class="mt-4 flex">
 <div>
 <?php if (isset($component)) { $__componentOriginald8ba2b4c22a13c55321e34443c386276 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8ba2b4c22a13c55321e34443c386276 = $attributes; } ?>
...
<?php endif; ?>
 ...
 <?php $__currentLoopData = $gotDemande->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <thead>
 <tr class="bg-gray-100">
 <?php if(isset($data['ancienne_adresse_etablissement']) || isset($data['nouvelle_adresse_etablissement'])): ?>
 ...
 <?php $__currentLoopData = $donnees["fichiers"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fichier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/demandes/new-demande.blade.php ENDPATH**/ ?>