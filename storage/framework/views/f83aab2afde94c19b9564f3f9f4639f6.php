...
<div style="display: inline-block;margin-right: 20px; ">
    ...
    <div style="display: inline-block;">
        ...
        <select  class="block  focus:border-first-orange enlever_shadow rounded  shadow-first-orange text-sm border-2" name="niveau_id"wire:model="selectedNiveauDiplome" id="selectedNiveauDiplome" name="niveauetude_id" wire:change="$refresh">
             ...
             <?php $__currentLoopData = $diplome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <thead>
                ...
                <tbody class="bg-white divide-y ">
                    <?php
                        $num = 1;
                    ?>
                    <?php $__empty_1 = true; $__currentLoopData = $niveauetudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/parametrage/niveauetude/liste-niveauetude.blade.php ENDPATH**/ ?>