        ...
        <div class="bg-white p-6 rounded">
            <div class="flex justify-end mb-3">
                <button wire:click = "addRole" class="bg-first-orange py-0.5 text-sm hover:bg-cyan-700 px-3 text-white font-bold rounded">
                    <?php echo e($modifying ? "valider" : "ajouter un profil"); ?>
            ...
            <?php if($allRoles->count() > 0): ?>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 ">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $allRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $profilHasAccess = $roles->contains('id', $profil->id);
                                ?>
                                <?php if($modifying || $profilHasAccess): ?>
                                    <tr class="border-b border-gray-200">
                                        <?php if($modifying): ?>
                                            <td class="px-3 py-2">
                                                <input type="checkbox" wire:model="selection" value="<?php echo e($profil->id); ?>">
                                            </td>
                                        ...
                                        <td class="px-3 py-2">
                                            <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                                <a href="<?php echo e(route("profil.show", $profil->id)); ?>" class="text-maquette-gris">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/manage-notify-profil.blade.php ENDPATH**/ ?>