...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Visualisation de la matiere')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            ...
            <a href="<?php echo e(route('matiere.index')); ?>"  class="text-maquette">Référentiel</a>
              <span class="mx-2 text-maquette">/</span>
        <p> <a href="<?php echo e(route('matiere.index')); ?>" >Matiere  </a>
            
            <span class="mx-2 text-maquette">/</span>
        </p>

        <p class="text-first-orange">Détail de la matiére</p>
        </p>
        ...
        <div class="w-full mx-auto max-w-6xl">
            <div class="rounded-lg shadow-sm px-8 py-5 bg-white">
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange py-2">
                           ...
                           href="<?php echo e(route('matiere.edit', $matiere->id)); ?>">
                           Modifier
                       </a>
                               </h3>
                <div class="border border-gray-200 p-4">
                    <div class="flex justify-between text-black items-center mt-3 text-sm">
                        <div>
                            <span>Code de la matiere : </span>
                            <span>
                                <b><?php echo e($matiere->code ?? ' - '); ?></b>
                            </span>
                        </div>
                        <div>
                            <span>Libellé de la matiere : </span>
                            <span>
                                <b><?php echo e($matiere->nom ?? ' -'); ?></b>
                            </span>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/matiere/show.blade.php ENDPATH**/ ?>