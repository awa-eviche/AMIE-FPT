<div>
    <div class="max-w-10xl mx-auto">
        ...
        <span class="text-first-orange font-bold text-sm">
                <a href="<?php echo e(route('liste.index')); ?>">Lister les éléments de paramètrage </a>
                    / <span class="text-orange-600"> liste
                    <?php echo e($liste->nom); ?></span></span>
            <a href="<?php echo e(route('liste.create')); ?>"
                ...
                </svg><span class="mx-2">Ajouter un liste</span>
            </a>
        </div>
    </div>
        ...
        <div class="flex md:w-full  flex-col">
            ...
            <div class="border border-gray-200">
             <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                        ...
                        href="<?php echo e(route('liste.edit', $liste->id)); ?>" style='position:relative;left: 83%;'>
                        Modifier
                    </a>
                            </h3>
                ...
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                        <span>Libelle de la liste : </span>
                        <span>
                            <b><?php echo e($liste->libelle ?? ' - '); ?></b>
                        </span>
                    </div>
                    <div>
                        <span>Valeur de la liste : </span>
                        <span>
                            <b><?php echo e($liste->valeur ?? ' -'); ?></b>
                        </span>
                    </div>
                </div>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/listes/detail-liste.blade.php ENDPATH**/ ?>