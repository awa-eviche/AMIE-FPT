<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('filiereetablissement.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <?php $__currentLoopData = $filiereetablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filiereetablissement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="w-full h-auto bg-white">
    <!--img class="w-full h-auto" src="<?php echo e(asset('assets/images/gray.jpg')); ?>" alt="Sunset in the mountains"-->
    <div class="px-3 py-4">
        <div class="font-bold text-xl mb-2 "><?php echo e($filiereetablissement->filiere->nom ?? '-'); ?></div>
      
    </div>
    
    <div class="px-3 py-2" >
        <!--span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 text-orange-500"><i class="fa fa-key"></i></span-->
        <!--span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 text-red-700"><i class="fa fa-trash"></i></span-->



        <div class="px-3 py-2"  >
        <a href="<?php echo e(route('filiereetablissement.show', $filiereetablissement->id)); ?>" class="mx-2 px-5 rounded-md py-4 flex text-white text-xs font-semibold text-center shadow-md bg-first-orange items-center justify-center " style="width:100px; position:relative;left:60%;">
            <span class="mx-2 font-bold" style="font-size:12px;">Voir plus</span>
        </a>
    </div>
    </div>
</div>
...
</div><?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/filiereetablissement/liste-filiereetablissement.blade.php ENDPATH**/ ?>