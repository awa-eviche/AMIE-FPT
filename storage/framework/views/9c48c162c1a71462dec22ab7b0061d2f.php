<div>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouvel élément de compétence (ajout multiple)')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            ...
            <span class="mx-2 text-maquette">/</span>
            <a href="<?php echo e(route('elementcompetence.index')); ?>" class="text-maquette">Élément de Compétence</a>
            <span class="mx-2 text-maquette">/</span>
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
                ...
                <select wire:model="niveau_etude_id" wire:change="$refresh"
                        class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 enlever_shadow" required>
                    <option value="">-- Sélectionner --</option>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($n->id); ?>"><?php echo e($n->nom); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </select>
            </div>
            ...
            <div>
                ...
                <select wire:model="competence_id" wire:change="$refresh"
                        class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 enlever_shadow" required>
                    <option value="">-- Sélectionner --</option>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $competences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="border border-gray-300 p-4 mb-4 rounded bg-gray-50">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label>Code</label>
                        <input type="text" wire:model="rows.<?php echo e($index); ?>.code" required
                               class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 enlever_shadow">
                    </div>

                    <div>
                        <label>Nom</label>
                        <input type="text" wire:model="rows.<?php echo e($index); ?>.nom" required
                               class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 enlever_shadow">
                    </div>

                    <div>
                        <label>Description</label>
                        <input type="text" wire:model="rows.<?php echo e($index); ?>.description" required
                               class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 enlever_shadow">
                    </div>
                </div>
...
<?php /**PATH C:\wamp64\www\AMIE-FPT\resources\views/livewire/parametrage/element-competence/element-competence-multi-fixed.blade.php ENDPATH**/ ?>