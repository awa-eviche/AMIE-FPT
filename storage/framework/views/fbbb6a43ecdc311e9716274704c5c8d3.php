<div>
    ...
    <select id="selectedEtablissement" wire:model="selectedEtablissement" wire:change="$refresh" class="border border-gray-300 p-3 w-full max-w-xs focus:border-first-orange enlever_shadow rounded px-8 py-0.75 shadow-first-orange text-sm font-bold">
        <option value="">Choisir un établissement</option>
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $etablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($etab->id); ?>"><?php echo e($etab->sigle ?? $etab->nom); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
    </select>
</div>
            <div class="flex items-baseline my-2 w-full">
...
<?php /**PATH C:\env_dev\projets\AmieFPT\AMIE-FPT\resources\views/livewire/dfpt/getallapprenant.blade.php ENDPATH**/ ?>