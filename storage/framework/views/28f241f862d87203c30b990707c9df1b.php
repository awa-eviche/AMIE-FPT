...
<div class="flex mb-5 justify-between">
 ...
 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('gerer_parametrage')): ?>
            <a href="<?php echo e(route('matiere.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
...
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> matiéres trouvées</span></div>
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $matieres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matiere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            ...
                            <td class="px-6 py-3 border-b"><?php echo e($matiere->code ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($matiere->nom ?? '-'); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($matiere->metier->nom ?? '-'); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($matiere->niveau_etude->nom ?? '-'); ?></td>
       <td class="px-6 py-3 border-b"><?php echo e($matiere->coef ?? '-'); ?></td>
                                ...
                                <div class="relative" x-data="{ open: false }" @click.away="open = false"
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('matiere.edit', $matiere->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/parametrage/matiere/liste-matiere.blade.php ENDPATH**/ ?>