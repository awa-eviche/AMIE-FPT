<div>
    <?php if($reunionUser->has_signed): ?>
        <p class="text-center text-first-orange mt-5">Vous avez déjà validé ce PV </p>
    <?php else: ?>
        <div class="flex justify-end">
            <button wire:click ="toggleRefused" class="mx-3 bg-first-orange hover:shadow-xl px-3 py-1 rounded text-white">Demander correction</button>
            <button wire:click="valider" class="ml-3 bg-first-orange px-3 py-1 text-bold hover:shadow-xl rounded text-white">Valider</button>
            ...
            <div class="px-10 min-h-96 py-10">
                ...
                <div class="mb-4 mx-auto w-full">
                    ...
                    <div class="flex justify-end mt-10">
                        <button wire:click="toggleRefused" class="bg-gray-300 hover:bg-gray-500 hover:shadow-xl px-3 py-1 rounded text-sm-center">
                            Annuler
                        </button>

                        <button wire:click="refuser" class="hover:bg-red-900 hover:shadow-xl flex items-center bg-red-700 text-white py-2 px-4 text-sm rounded mx-2" <?php echo e($disabled ? 'disabled' : ''); ?>>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/reunions/valider-pv.blade.php ENDPATH**/ ?>