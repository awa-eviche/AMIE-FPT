...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="<?php echo e(route("profil.index")); ?>"  class="text-maquette-gris">Liste des profil</a>
        </p>
        <span class="mx-2 text-maquette-gris">/</span>
        <p class="text-first-orange">Nouveau profil</p>
    </div>
   
   <div class="bg-white shadow rounded-sm w-full">
    <div class="w-full mx-auto max-w-2xl">
        <form action="<?php echo e(route('profil.store')); ?>" method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center">
                    <label class="mr-4">
                        <input type="radio" name="est_actif" value="1" class="form-radio text-blue-600" <?php echo e(old('est_actif') == '1' ? 'checked' : ''); ?>>
                        <span class="ml-2">Actif</span>
                    </label>
                    <label>
                        <input type="radio" name="est_actif" value="0" class="form-radio text-red-600" <?php echo e(old('est_actif') == '0' ? 'checked' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/profils/create.blade.php ENDPATH**/ ?>