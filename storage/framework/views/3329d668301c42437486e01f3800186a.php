<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900">
        <div class="md:container md:mx-auto">
            ...
            <div class="mt-4 mb-2">
                <a href="<?php echo e(route('permissions.index')); ?>" class="text-blue-500 hover:underline">&larr; Retour à la liste des permissions</a>
            </div>
            <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                ...
                <?php if(isset($permission)): ?>
                    <?php echo Form::hidden('permission_id', $permission->id); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/amie-fpt/resources/views/admin/permissions/partials/_form.blade.php ENDPATH**/ ?>