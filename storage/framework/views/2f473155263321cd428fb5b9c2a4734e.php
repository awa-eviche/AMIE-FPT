    ...
    <label for="filiere" style="text-align:center;">Filtrer par filiére :</label><br>
        <select  class="block  focus:border-first-orange enlever_shadow rounded  shadow-first-orange text-sm border-2" name="secteur_id" wire:model="selectedMetierFiliere" id="selectedMetierFiliere" wire:change="$refresh">
            <option value="">Sélectionner une filiére</option> 
             <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $filiere; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filieres): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/parametrage/metier/liste-metier.blade.php ENDPATH**/ ?>