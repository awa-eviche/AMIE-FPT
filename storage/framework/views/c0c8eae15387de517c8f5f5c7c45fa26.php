...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="<?php echo e(route('filiereetablissement.index')); ?>" class="text-maquette">Accueil</a>
            <span class="mx-2 text-maquette">/</span>
            <a href="<?php echo e(route('filiereetablissement.index')); ?>" class="text-maquette">Filière</a>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('filiereetablissement.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                        ...
                        <div class="flex-grow mb-4 mr-2">
                            ...
                            <select class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" id="filiere_id" name="filiere_id">
...
<?php endif; ?><?php /**PATH /var/www/html/amie-fpt/resources/views/filiereetablissement/create.blade.php ENDPATH**/ ?>