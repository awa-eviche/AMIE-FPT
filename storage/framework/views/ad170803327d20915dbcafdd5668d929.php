...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__("Nouveau Niveau Etude")); ?>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('niveauetude.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                    Création d'un niveau d'étude
                </h3>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label for="metier_id">Sélectionner un métier :</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline enlever_shadow" id="diplome_id" name="diplome_id">
                            ...
                            <option value="<?php echo e($diplome->id); ?>"><?php echo e($diplome->nom); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'ann_id','class' => 'block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 ','type' => 'number','name' => 'annee','min' => '1','max' => '10','value' => old('annee'),'autofocus' => true,'autocomplete' => 'annee']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'ann_id','class' => 'block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 ','type' => 'number','name' => 'annee','min' => '1','max' => '10','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('annee')),'autofocus' => true,'autocomplete' => 'annee']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/niveauetude/create.blade.php ENDPATH**/ ?>