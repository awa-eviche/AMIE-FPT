<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('inspecteur.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
    ...
    <div class="w-full bg-transparent rounded-lg shadow-xs p-0 flex flex-wrap">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $inspecteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inspecteur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="sm:w-1/3 w-full p-4">
            <div class="rounded-lg shadow-md p-4 bg-white3">
                <h1 class="font-bold text-lg"><i class="fa-solid fa-user text-orange-clair">   </i> <?php echo e($inspecteur->prenom); ?> <?php echo e($inspecteur->nom); ?></h1>
                <hr class="my-2" />
                <div class="flex mb-4 items-center">
                    <img class="rounded-lg w-1/3 sm:w-1/6" src="<?php echo e(asset('storage/inspecteurs/'. $inspecteur->logo)); ?>" alt="Logo" />
                    <div class="px-4 flex-1">
                        <h3 class="text-sm py-1"><i class="text-orange-clair fa fa-location"></i>&nbsp;Email : <span class="font-bold"><?php echo e($inspecteur->email ?? ' - '); ?></span></h3>
                        <h3 class="text-sm py-1"><i class="text-orange-clair fa fa-list"></i>&nbsp;Telephone : <span class="font-bold"><?php echo e($inspecteur->telephone ?? ' - '); ?></span></h3>
                        <h3 class="text-sm py-1"><i class="text-orange-clair fa fa-list"></i>&nbsp;Specialite : <span class="font-bold"><?php echo e($inspecteur->specialite ?? ' - '); ?></span></h3>

                        <h3 class="text-sm py-1"><i class="text-orange-clair fa fa-list"></i>&nbsp;IA :<?php echo e($inspecteur->ia->nom ?? ' - '); ?></h3>
                    </div>
                    <div class="px-4 flex items-end">
                        <div class="flex items-center <?php echo e($inspecteur->is_active ? 'bg-orange-100' : 'bg-red-100'); ?> px-4 py-1 rounded-lg">
                            <i class="fa fa-circle <?php echo e($inspecteur->is_active ? 'text-orange-600' : 'text-red-600'); ?> text-xs pr-3"></i>
                            <h3><?php echo e($inspecteur->is_active ? 'Actif' : 'Inactif'); ?></h3>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="mt-4">
                    <div class="flex justify-between items-center mt-3">
                        <a href="<?php echo e(route('inspecteur.edit',$inspecteur->id)); ?>" class="flex items-center px-1 rounded-md py-1 border flex text-orange-600 text-sm text-center bg-white border-orange-600 hover:bg-orange-600 hover:text-white">
                            <i class="fa fa-edit"></i>
                            <span class="mx-2">Modifier</span>
                        </a>
                        <a href="<?php echo e(route('inspecteur.show',$inspecteur->id)); ?>" class="flex items-center px-1 rounded-md py-1 border flex text-green-600 text-sm text-center bg-white border-green-600 hover:bg-green-600 hover:text-white">
                            <i class="fa fa-eye"></i>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/inspecteur/liste-inspecteur.blade.php ENDPATH**/ ?>