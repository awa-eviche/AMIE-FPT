<div class="sm:px-2 lg:px-2">
    ...
    <div class="shadow-lg">
        <div class="flex items-center justify-between bg-gray-200 p-1 mt-2">
            <p class="text-first-orange font-bold">Les documents à téléverser pour ce <?php echo e($monNomEntite); ?></p>
        </div>
        <div class="bg-white p-3 rounded">
            <div class="flex justify-end mb-3">
                <button wire:click = "toggleIsAdding" class="bg-first-orange py-0.5 text-sm hover:bg-cyan-700 px-3 text-white font-bold rounded">
                    <?php echo e($isAdding ? "Annuler" : "Ajouter document"); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'libelle','value' => ''.e(__('Label')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'libelle','value' => ''.e(__('Label')).'']); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <?php if (isset($component)) { $__componentOriginald8ba2b4c22a13c55321e34443c386276 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8ba2b4c22a13c55321e34443c386276 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'description','value' => ''.e(__('description')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['wire:model.defer' => 'description','id' => 'description','class' => 'block mt-1 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm','type' => 'text','name' => 'description','value' => old('description'),'required' => true,'autofocus' => true,'autocomplete' => 'description']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.defer' => 'description','id' => 'description','class' => 'block mt-1 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm','type' => 'text','name' => 'description','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('description')),'required' => true,'autofocus' => true,'autocomplete' => 'description']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="border-b border-gray-200 ">
                                        ...
                                        <td class="px-3 py-2 w-[100px]">
                                            <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                                <button wire:click="setDetailedDocumentId(<?php echo e($document->id); ?>)" class="text-maquette-gris">
                                                ...
                                                <button wire:click="setModifyingDocumentId(<?php echo e($document->id); ?>)" class="text-maquette-gris">
                                                ...
                                                <button wire:click="supprimer(<?php echo e($document->id); ?>)" class="text-maquette-gris">
                                    ...
                                    <?php if($modifyingDocumentId == $document->id): ?>
                                        <tr>
                                            <td colspan="3">
                                                <?php
...
[$__name, $__params] = $__split('type-document-form', ['document' => $document]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1373198515-0', $__slots ?? [], get_defined_vars());
...
?>
                                    ...
                                    <?php if(!$isModifying && $document->id == $detailedDocumentId): ?>
                                        <tr>
                                            <td colspan="3">
            ...
            <?php else: ?>
                <p class="text-sm text-first-orange">Aucun document n'est requis pour ce <?php echo e($monNomEntite); ?> pour l'instant !.</p>
            <?php endif; ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/manage-type-demande-documents.blade.php ENDPATH**/ ?>