...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Détails de la Demande')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold px-4">
        <p>
            <a href="<?php echo e(route("demande.index")); ?>" class="text-black">Liste des demandes</a>
        </p>
        ...
        <div class="bg-white" x-show.transition="step == 1">
            <div class="flex justify-between px-4 py-4 mt-4">
                <div class="flex items-center">
                    ...
                    <?php switch($demande->etat->status):
               ...
               <?php if((($demande->etat->code != "conforme_1") || ($demande->etat->code != "non_conforme_1")) && Auth::user()->isSuperAdmin()): ?>
                <button class="bg-first-orange text-white rounded py-2 px-4 mr-5 font-bold">
                    <a href="<?php echo e(route('demande.genererRecepisser', $demande->id)); ?>">Générer</a>
                </button>
                <?php endif; ?>


                
            <?php if($demande->etat->position == 1): ?>
            <div class="flex justify-end">
                <button class="bg-first-orange text-white rounded-sm py-1 px-2 mr-5 font-bold text-sm">
                    <a href="<?php echo e(route('demande.completer', $demande->id)); ?>">Completer la demande</a>
                </button>
            </div>
...
[$__name, $__params] = $__split('demandes.set-etat-demande', ['demande' => $demande]);

$__html = app('livewire')->mount($__name, $__params, 'lw--1754443715-0', $__slots ?? [], get_defined_vars());
                            ...
                            <div class="p-2 mb-2">
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <span class="text-black"><?php echo e($demande->typeDemande->libelle ?? " - "); ?></span>
                                    </div>
                                </div>
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        <strong class="text-black">Libellé :</strong>
                                        <span class="text-black"><?php echo e($demande->libelle ?? " - "); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <?php if($demande->est_rejete == true ): ?>
                                        <span class="bg-red-200 py-1 px-2 rounded text-sm text-red-800 font-bold">Rejeté</span>
                                        <?php else: ?>
                                        <span class="bg-green-200 py-1 px-2 rounded text-sm text-green-800 font-bold"><?php echo e($demande->etat->libelle?? " - "); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <span class="text-black"><?php echo e(date('d-m-Y',strtotime($demande->date_depot) ?? " ")); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-end py-3 px-4">
                                    ...
                                    <p class="text-sm font-bold bg-first-orange px-2 py-1 rounded text-white hover:bg-green-700">
                                        <a href="<?php echo e(route('demande.edit', $demande->id)); ?>" class="flex items-center">
                                            <span class="mr-2"><?php echo e(auth()->user()->hasRole(config('constants.roles.ia')) ? "Joindre le rapport d'enquête" : "Modifier"); ?></span>
                    ...
                    <div class="w-1/2 px-8 py-2 flex-1">
                        <div class="w-full mx-auto shadow mt-2 rounded border border-gray-200 border-2">
                            <div class="p-2 mb-2">
                                ...
                                <hr>
                                <?php if(($demande->typeDemande->code == config('constants.requests.D-OUVERTURE-ETABLISSEMENT')) || 
                                ...
                                <?php $__currentLoopData = $demande->projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mt-4 mb-2 flex w-full px-4 items-center justify-between">
                                    <div class="">
                                        <strong class="text-black">Filière :</strong>
                                        <span class="text-black"><?php echo e($projet->filiere->nom ?? " - "); ?></span>
                                    </div>
                                    <div class="">
                                        <strong class="text-black">Niveau :</strong>
                                        <span class="text-black"><?php echo e($projet->niveau->nom ?? " - "); ?></span>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if(($demande->typeDemande->code == config('constants.requests.D-AUTORISATION-DIRIGER'))): ?>
                                <?php $__currentLoopData = $demande->projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mt-4 mb-2 flex w-full px-4 items-center justify-between">
                                    <div class="">
                                        <strong class="text-black">Nom :</strong>
                                        <span class="text-black"><?php echo e($projet->nom ?? " - "); ?></span>
                                    </div>
                                    <div class="">
                                        <strong class="text-black">Prénom :</strong>
                                        <span class="text-black"><?php echo e($projet->prenom ?? " - "); ?></span>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if(($demande->typeDemande->code == config('constants.requests.D-CHANGEMENT-DENOMINATION'))): ?>
                                <?php $__currentLoopData = $demande->projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mt-4 mb-2 flex w-full px-4 items-center justify-between">
                                    <div class="">
                                        <strong class="text-black">Ancienne dénomination :</strong>
                                        <span class="text-black"><?php echo e($projet->ancienne_denomination_etablissement     ?? " - "); ?></span>
                                    </div>
                                    <div class="">
                                        <strong class="text-black">Nouvelle dénomination :</strong>
                                        <span class="text-black"><?php echo e($projet->nouvelle_denomination_etablissement ?? " - "); ?></span>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if(($demande->typeDemande->code == config('constants.requests.D-TRANSFERT-ETABLISSEMENT'))): ?>
                                <?php $__currentLoopData = $demande->projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mt-4 mb-2 flex w-full px-4 items-center justify-between">
                                    <div class="">
                                        <strong class="text-black">Ancienne adresse :</strong>
                                        <span class="text-black"><?php echo e($projet->ancienne_adresse_etablissement     ?? " - "); ?></span>
                                    </div>
                                    <div class="">
                                        <strong class="text-black">Nouvelle adresse :</strong>
                                        <span class="text-black"><?php echo e($projet->nouvelle_adresse_etablissement ?? " - "); ?></span>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if(($demande->typeDemande->code == config('constants.requests.D-QUALIFICATION-FILIERE'))): ?>
                                <?php $__currentLoopData = $demande->projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mt-4 mb-2 flex w-full px-4 items-center justify-between">
                                    <?php $__currentLoopData = $projet->aire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="">
                                        <strong class="text-black">Filière :</strong>
                                        <span class="text-black"><?php echo e($a['filiere']     ?? " - "); ?></span>
                                    </div>
                                    <div class="">
                                        <strong class="text-black">Niveau :</strong>
                                        <span class="text-black"><?php echo e($a['niveau'] ?? " - "); ?></span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if(($demande->typeDemande->code == config('constants.requests.D-SUBVENTION'))): ?>
                                <?php $__currentLoopData = $demande->projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mt-4 mb-2 flex w-full px-4 items-center justify-between">
                                    <div class="">
                                        <strong class="text-black">Pour l'année académique :</strong>
                                        <span class="text-black"><?php echo e($projet->anneeAcademique->annee1 . ' - '.  $projet->anneeAcademique->annee2); ?></span>
                                    </div>
                        ...
                        <div class="p-1 border-gray-200 border-2 shadow-xl border rounded">
                            <div class="pt-2 mb-2">
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        <strong class="text-black">Nom :</strong>
                                        <span class="text-black"><?php echo e($demande->etablissement->nom ?? " - "); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <span class="text-black"><?php echo e($demande->etablissement->email?? " - "); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <span class="text-black"><?php echo e(date('d-m-Y',strtotime($demande->etablissement->dateCreation) ?? " ")); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <span class="text-black"><?php echo e($demande->etablissement->commune->libelle?? " - "); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <span class="text-black"><?php echo e($demande->etablissement->type?? " - "); ?></span>
                                    </div>
                                </div>
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        <strong class="text-black">Statut :</strong>
                                        <span class="text-black"><?php echo e($demande->etablissement->statut?? " - "); ?></span>
                                    </div>
                                </div>
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        <strong class="text-black">Statut Juridique :</strong>
                                        <span class="text-black"><?php echo e($demande->etablissement->statutJuridique?? " - "); ?></span>
                                    </div>
                                </div>
                            ...
                            <div class="pt-2 mb-2">
                                ...
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        ...
                                        <span class=""><?php echo e($demande->demandeur->nom . ' '.  $demande->demandeur->prenom ?? " - "); ?></span>
                                    </div>
                                </div>
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        <strong class="text-black">Email :</strong>
                                        <span class=""><?php echo e($demande->demandeur->email  ?? " - "); ?></span>
                                    </div>
                                </div>
                                <div class="mt-4 mb-2 flex">
                                    <div class="flex w-full px-4 items-center justify-between">
                                        <strong class="text-black">Adresse :</strong>
                                        <span class="text-black"><span class=""><?php echo e($demande->demandeur->adresse  ?? " - "); ?></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
[$__name, $__params] = $__split('etude-demande.gerer-document', ['demande' => $demande]);

$__html = app('livewire')->mount($__name, $__params, 'lw--1754443715-1', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="mt-5 border border-gray-100">
            ...
            <ul class="list-disc pl-4 flex flex-wrap justify-evenly">
                ...
                <?php $__currentLoopData = $demande->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-center justify-between mb-2 bg-gray-100 w-[350px] m-3 p-3">
                    ...
                    <div class="flex items-center w-[290px] overflow-hidden">
                        ...
                        <span class="ml-3 w-[265px] overflow-hidden"><?php echo e($document["nom"]); ?></span>
                    </div>
                ...
                <tr class="border-b">
                    <td class="p-4">
                        <div class="relative">
                            ...
                            <div class="flex">
                                ...
                                <p class="text-first-orange"><?php echo e($historique->etatWorkflow->libelle); ?></p>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <p class="text-green-600"><?php echo e($historique->etatWorkflow->libelle); ?></p>
                            </div>
                    ...
                    <td class="p-4">
                        <div class="text-gray-700 text-sm">
                            <?php echo e(\Carbon\Carbon::parse($historique->date_entree)->format('d M Y, H:i:s')); ?>

                        </div>
                        <div class="mb-2"><?php echo e($historique->etatWorkflow->description ?? " - "); ?></div>
                    </td>
                    <td class="p-4">
                        <div class="font-bold mb-2"><?php echo e($historique->user->prenom); ?> <?php echo e($historique->user->nom); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/amie-fpt/resources/views/demandes/show.blade.php ENDPATH**/ ?>