...
<?php echo Form::model(new \App\Models\Newsletter(), ['route' => ['store.newsletters'], 'role' => 'form', 'class' => 'apix-form', 'files' => 'true']); ?>
            ...
            <div class="md:container md:mx-auto">
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-4">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <?php echo Form::text('newsletter_object', null, ['id' => 'newsletter_object', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Objet de la newsletter']); ?>
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <?php echo Form::text('newsletter_content', null, ['id' => 'richEd', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => '']); ?>
...
<?php echo $__env->make('layouts.v1.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/amie-fpt/resources/views/admin/front/newsletters/create.blade.php ENDPATH**/ ?>