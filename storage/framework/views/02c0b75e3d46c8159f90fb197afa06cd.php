...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('filiere.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
    ...
    <label for="secteur" style="text-align:center;">Filtrer par secteur :</label><br>
        <select  class="block  focus:border-first-orange enlever_shadow rounded  shadow-first-orange text-sm border-2 "name="filiere_id" wire:model="selectedFiliereSecteur" id="selectedFiliereSecteur" wire:change="$refresh">
            <option value="">Sélectionner un secteur</option> 
             <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $secteur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secteurs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> filiéres trouvées</span></div>
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $filieres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filiere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <td class="px-6 py-3 border-b"><?php echo e($num); ?></td>
                            <td class="px-6 py-3 border-b"><?php echo e($filiere->code ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($filiere->nom ?? '-'); ?></td>
                            
                            <td class="px-4 py-3 border-b"><?php echo e($filiere->secteur->libelle ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('filiere.show', $filiere->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('filiere.edit', $filiere->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/parametrage/filiere/liste-filiere.blade.php ENDPATH**/ ?>