...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Materiels affectés')); ?>
    ...
    <div class="w-full rounded-lg shadow-xs p-0">
        <div class="text-sm w-full p-0">
            ...
            <thead>
                                    ...
                                    <th class="px-4 py-4">Nom du materiel</th>
                                        <th class="px-4 py-4">Numéro de serie</th>
                                        <th class="px-4 py-4 text-white font-norma">Type</th>
                                        <th class="px-4 py-4 text-white font-norma ">Modéle</th>
                                        <th class="px-4 py-4 text-white font-norma ">Date d'achat</th>
                                        <th class="px-4 py-4 text-white font-norma ">Date de mise en service</th>
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $materiels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materiel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                                    ...
                                    <td class="px-6 py-3 border-b"><?php echo e($materiel->name ?? ' - '); ?></td> 
                            <td class="px-6 py-3 border-b"> <?php echo e($materiel->serial_number ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($materiel->type ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($materiel->modele ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($materiel->date_achat ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($materiel->date_mise_en_service ?? ' - '); ?></td>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/materiel/index.blade.php ENDPATH**/ ?>