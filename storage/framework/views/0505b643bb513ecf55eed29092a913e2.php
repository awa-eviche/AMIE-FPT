...
<div class="mx-auto max-w-screen-lg pt-10 mb-[5%]">
    ...
    <div class="flex flex-wrap justify-center -mx-4">
        <div class="grid w-full grid-cols-1 gap-6 mx-auto lg:grid-cols-3">
            <?php $__currentLoopData = $actualites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-6">
                <img class="object-cover object-center w-full mb-8 lg:h-48 md:h-36 rounded-xl"
                     src="<?php echo e(asset('storage/' . $new->image)); ?>" alt="blog">
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('actualites.show', ['id' => $new->id])); ?>"
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/actualite.blade.php ENDPATH**/ ?>