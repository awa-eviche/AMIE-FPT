...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container p-y rounded">
        <div class="flex justify-between items-center">
            <h2 class="text-first-orange font-bold">Liste des Profils</h2>
            <div class="flex justify-end mb-4">
                <a href="<?php echo e(route('profil.create')); ?>" class="flex items-center bg-first-orange hover:bg-cyan-700 text-white font-bold py-1 px-4 text-sm rounded">
                   <span class="mr-2">Nouvel profil</span>
                   <svg style="fill: white" height="15" width="15" viewBox="0 0 448 512">
            ...
            <div class="w-full overflow-x-scroll ">
                <table class="w-full border-t">
                    ...
                    <tbody class="bg-white divide-y">
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-gray-700">
                                <td class="px-4 py-3 border-b"><?php echo e($profil->code); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($profil->name); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($profil->description); ?></td>
                                <td class="px-4 py-3 border-b">
                                    <?php if($profil->est_actif): ?>
                                ...
                                <td class="px-4 py-3 border-b">
                                    <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                        ...
                                        <a href="<?php echo e(route('profil.edit', $profil->id)); ?>" class="text-purple-600">
                                        ...
                                        <form class="text-center" action="<?php echo e(route('profil.destroy', $profil->id)); ?>" method="POST">
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/profils/index.blade.php ENDPATH**/ ?>