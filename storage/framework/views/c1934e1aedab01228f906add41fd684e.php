...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouvel IEF')); ?>

        </h2>
     <?php $__env->endSlot(); ?>

    <div class="flex mb-4 text-sm font-bold p-3 bg-white p-3 bg-white">
        <p>
        ...
        <p class="text-first-orange">Nouveau IEF</p>
        </p>
             
            
    </div>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded">
        ...
        <form action="<?php echo e(route('ief.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
            <?php echo csrf_field(); ?>
            <div class="border border-gray-200">
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                    Formulaire d'ajout d'un nouvel Ief
                </h3>
...
<?php endif; ?>
                    <div class="checkbox-columns" style="column-count: 4; column-gap: 20px;">
                        ...
                        <div class="form-check" style="margin-bottom: 10px;">
                            <input class="form-check-input" type="checkbox" id="commune<?php echo e($commune->id); ?>" name="communes[]" value="<?php echo e($commune->id); ?>">
...
<?php endif; ?><?php /**PATH /var/www/html/amie-fpt/resources/views/ief/create.blade.php ENDPATH**/ ?>