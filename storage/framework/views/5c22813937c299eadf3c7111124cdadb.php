<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 m-2">
        ...
        <?php $__currentLoopData = $les_metiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nom => $niveaux): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/niveauetudeetablissement/view-program-formation.blade.php ENDPATH**/ ?>