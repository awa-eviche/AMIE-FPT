    ...
    <div class="flex flex-wrap">
        <div class="md:w-2/5 lg:w-3/5 xl:w-2/5 md:py-44 md:px-36 sm:py-10 sm:px-12 wc-full">
            <div class="flex flex-col ...">
                <div class="text-white font-bold  md:text-5xl sm:text-2xl pt-10"><?php echo e($actualite->title); ?></div>
...
<div class="mx-auto max-w-screen-lg pt-10 mb-[5%]">
    <h1 class="text-4xl text-first-orange pb-10 font-bold"><?php echo e($actualite->title); ?></h1>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/actualite_show.blade.php ENDPATH**/ ?>