<?php $__env->startSection('content'); ?>
    <?php echo Form::model(NULL, ['method' =>'PUT', 'route' => ['demande.rejet', $id], 'role' => 'form',
    'class' => 'apix-form', 'files' => 'true']); ?>

    <?php $inputClass = "bg-gray-300 border border-gray-400 text-gray-600 text-sm rounded-lg focus:ring-gray-400 focus:border-gray-400 block w-full p-2.5 " ?>
                ...
                <div class="sm:container sm:mx-auto">
                    <div class="grid md:gap-3 pt-2">
                        <div class="relative  w-full mb-3 ">
                            <?php echo Form::textarea('decision', null, ['id' => 'decision', 'class' => $inputClass, 'required' => '', 'placeholder'=>'Saisissez ici pour motivier votre décision !']); ?>
                    ...
                    <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                        <div class="relative z-0 w-full mb-3 group">
                            ...
                            <a href="<?php echo e(route('users.index')); ?>" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                                Annuler </a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.v1.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/etats/motifRejet.blade.php ENDPATH**/ ?>