...
<div class="flex mb-5 justify-between">
        ...
        <a href="#" class="mx-2 px-5 rounded-md py-0 flex text-orange-400 text-xs font-bold text-center shadow-md bg-white items-center">
            ...
            <a href="<?php echo e(route('metier.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
...
<br>
<?php if($count): ?>
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> métiers trouvés</span></div>
<?php endif; ?>
            ...
            <tr class="text-xs font-black tracking-wide text-left text-maquette-gris font-bold uppercase border-b bg-first-orange">
                ...
                <tbody class="bg-white divide-y ">
                    <?php
                        $num = 1;
                    ?>
                    <?php $__empty_1 = true; $__currentLoopData = $metiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            
                     
                                    <td class="px-6 py-3 border-b"><?php echo e($num); ?></td> 
                            <td class="px-6 py-3 border-b"><?php echo e($metier->code ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($metier->nom ?? '-'); ?></td>
                            
                            <td class="px-4 py-3 border-b"><?php echo e($metier->filiere->nom ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('metier.show', $metier->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('metier.edit', $metier->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/parametrage/metier/liste-metier.blade.php ENDPATH**/ ?>