<div class="pr-5">
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <?php if(auth()->user()->can('edit_inscription') and !auth()->user()->hasRole(config('constants.roles.superadmin'))): ?>
            <a href="<?php echo e(route('inscription.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter une inscription</span>
    ...
    <div class="flex  -mx-3 mb-0  space-x-4 space-x-reverse" style="padding:8px;">
        <div class="w-full px-7">
            ...
            <select id="annee_academique" wire:model="selectedInscriptionAnnee" name="selectedInscriptionAnnee" wire:change="$refresh" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " required autofocus>
                <option value="">Choisissez une année académique</option>
                <?php $__currentLoopData = $annee_academique; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annee_academiques): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($annee_academiques->id); ?>"><?php echo e($annee_academiques->dateDebut); ?>-<?php echo e($annee_academiques->dateFin); ?></option>
        ...
        <div class="w-full px-7">
            ...
            <select id="inscription_id" wire:model="selectedInscriptionMetier" name="selectedInscriptionMetier" wire:change="$refresh" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " required autofocus>
                ...
                <option value="<?php echo e($metiers->id); ?>"><?php echo e($metiers->nom); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="w-full px-7">
            ...
            <select id="inscription_id" wire:model="selectedInscriptionClasse" name="selectedInscriptionClasse" wire:change="$refresh" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " required autofocus>
                <option value="">Choisissez une classe</option>
                <?php $__currentLoopData = $classe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($classes->id); ?>"><?php echo e($classes->libelle); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
                ...
                <table class="w-full whitespace-no-wrap" style="font-size: 10px;">
                    <thead>
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800 bg-gray-100" style="background-color: rgb(239, 241, 244); border-radius:7px; font-size: 12px;">
                            <th class="px-4 py-3">Apprenants</th>
                            <th class="px-4 py-3">Classe</th>
                            <th class="px-4 py-3">Metier</th>
                            <th class="px-4 py-3">Matiere</th>
                            <th class="px-4 py-3">Note Controle Continue Semestre1</th>
                            <th class="px-4 py-3">Note Composition Semestre1</th>
                            <th class="px-4 py-3">Note Controle Continue Semestre2</th>
                            <th class="px-4 py-3">Note Composition Semestre2</th>
...
<tr class="text-gray-700 dark:text-gray-400">
    <td class="px-4 py-3">
        <?php echo e($evaluation->inscription->apprenant->nom ?? '-'); ?> <?php echo e($evaluation->inscription->apprenant->prenom ?? '-'); ?> / <?php echo e($evaluation->inscription->apprenant->telephone ?? '-'); ?>

    </td>
    <td class="px-4 py-3 text-xs font-bold"><?php echo e($evaluation->inscription->classe->libelle ?? '-'); ?></td>
    <td class="px-4 py-3 text-xs font-bold"><?php echo e($evaluation->inscription->classe->niveau_etude->metier->nom ?? '-'); ?></td>
    <td class="px-4 py-3 text-xs font-bold"><?php echo e($evaluation->matiere->nom ?? '-'); ?></td>
    <td class="px-4 py-3 text-xs font-bold"><?php echo e($evaluation->note_cc_semestre1 ?? '-'); ?></td>
<td class="px-4 py-3 text-xs font-bold"><?php echo e($evaluation->note_composition_semestre1 ?? 'Non disponibles'); ?></td>
<td class="px-4 py-3 text-xs font-bold"><?php echo e($evaluation->note_cc_semestre2 ?? 'Non disponibles'); ?></td>
<td class="px-4 py-3 text-xs font-bold"><?php echo e($evaluation->note_composition_semestre2 ?? ' disponibles'); ?></td>

    <td class="px-4 py-3 text-xs">
        <?php if($evaluation->inscription && $evaluation->matiere): ?>
            <a href="<?php echo e(route('evaluation.edit', ['inscriptionId' => $evaluation->inscription->id, 'matiereId' => $evaluation->matiere->id])); ?>">
       ...
       &nbsp;&nbsp;&nbsp;
                    ...
                    'route' => array('evaluation.destroy', $evaluation->id))); ?>

                    <?php echo e(csrf_field()); ?>


<button class="text-red-500 mr-2 apix-delete" data-id="<?php echo e($evaluation->id); ?>" data-toggle="tooltip" title="Supprimer">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    </div><?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/evaluation/liste-evaluation.blade.php ENDPATH**/ ?>