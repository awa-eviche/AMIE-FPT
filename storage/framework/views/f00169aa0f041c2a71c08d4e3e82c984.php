...
<?php echo Form::model(new \App\Models\FrontActualite(), ['route' => ['update.actualite',$actualite->id], 'role' => 'form', 'class' => 'apix-form', 'files' => 'true']); ?>
        ...
        <div class="md:container md:mx-auto">
            ...
            <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                <div class="relative z-0 w-full mb-3 group">
                    ...
                    <?php echo Form::text('actualite_titre', $actualite->actualite_titre, ['id' => 'actualite_titre', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']); ?>

                </div>
                <div class="relative z-0 w-full mb-3 group">
                    <label for="prenom" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Publier/Dépublier</label>
                    <?php echo Form::select('actualite_is_active',[0=>'Dépublié',1=>'Publié'], $actualite->actualite_is_active, ['id' => 'actualite_is_active', 'class' => $inputClass.$pClass, 'required' => 'true']); ?>

                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <label for="nom" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Image principale</label>
                    <?php echo Form::file('actualite_main_pic', ['id' => 'actualite_main_pic', 'class' => $inputClass , 'placeholder'=>'Choisir une image']); ?>

                    <?php if(!empty($actualite->actualite_main_pic)): ?>
                    <img class="thumbnail-slider py-4" src="<?php echo e(asset('storage/front/actualites/'. $actualite->actualite_main_pic)); ?>" alt="<?php echo e($actualite->activite_main_pic); ?>" />
                    <?php endif; ?>
                </div>
            </div>
            <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <?php echo Form::text('actualite_corps',$actualite->actualite_corps, ['id' => 'richEd', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']); ?>
            ...
            <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <a href="<?php echo e(route('index.actualite')); ?>" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-3 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                        Annuler </a>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.v1.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/amie-fpt/resources/views/admin/front/actualites/edit.blade.php ENDPATH**/ ?>