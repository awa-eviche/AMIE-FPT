...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('secteur.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
...
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> secteurs trouvés</span></div>
            ...
            <table class="w-full border-t mb-3">
                ...
                <tbody class="bg-white divide-y ">
                    <?php
                        $num = 1;
                    ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $secteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $secteur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            
                        <td class="px-6 py-3 border-b"><?php echo e($num); ?></td>
                            <td class="px-6 py-3 border-b"><?php echo e($secteur->code ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($secteur->libelle ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('secteur.show', $secteur->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('secteur.edit', $secteur->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/parametrage/secteur/liste-secteur.blade.php ENDPATH**/ ?>