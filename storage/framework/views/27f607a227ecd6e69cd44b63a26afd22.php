    ...
    <div class="max-w-10xl mx-auto">
        <div class="flex justify-between items-center">
            <span class="text-black text-sm">Liste des entreprises / <span class="text-orange-600"> Entreprise
                    <?php echo e($entreprise->ninea); ?></span></span>
            <a href="<?php echo e(route('entreprise.create')); ?>"
    ...
    <div class="flex md:flex-wrap justify-between  mt-8 mb-10">
        <div class="flex md:w-full lg:w-1/2 gap-y-4 pr-4 flex-col">
            <div class="rounded-lg shadow-sm px-8 py-5 bg-white">
                <div class="flex justify-between text-black items-center">
                    ...
                    <a class="text-orange-600 bg-orange-100 text-sm rounded-md shadow-md px-4 py-1"
                        href="<?php echo e(route('entreprise.edit', $entreprise->id)); ?>">
                        Modifier
                    </a>
                </div>
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    ...
                    <span>
                        <?php echo e($entreprise->nom_entreprise ?? ' - '); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 text-sm">
                    <span>Email : </span>
                    <span>
                        <?php echo e($entreprise->email_entreprise ?? ' -'); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    <span>Effectif : </span>
                    <span>
                        <?php echo e($entreprise->effectif ?? ' - '); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    ...
                    <span>
                        <?php echo e(date('d/m/Y', strtotime($entreprise->date_creation)) ?? ' - '); ?>

                    </span>
                </div>
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    <span>Actif : </span>
                    <?php if($entreprise->est_actif): ?>
                        <span
            ...
            <div class="rounded-lg shadow-sm px-8 py-5 bg-white mt-3">
                ...
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <span>Nom : </span>
                    <span>
                        <?php echo e($entreprise->user->nom ?? ' - '); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 text-sm">
                    <span>Prénoms : </span>
                    <span>
                        <?php echo e($entreprise->user->prenom ?? ' -'); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    <span>Email : </span>
                    <span>
                        <?php echo e($entreprise->user->email ?? ' - '); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    <span>Téléphone : </span>
                    <span>
                        <?php echo e($entreprise->user->telephone ?? ' - '); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    <span>Adresse : </span>
                    <span>
                        <?php echo e($entreprise->user->adresse ?? ' - '); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    ...
                    <span>
                        <?php echo e(date('d/m/Y', strtotime($entreprise->user->date_naissance)) ?? ' - '); ?>
                ...
                <div class="flex justify-between text-black items-center mt-1 mb-2 text-sm">
                    ...
                    <span>
                        <?php echo e($entreprise->user->lieu_naissance ?? ' - '); ?>
        ...
        <div class="flex  w-1/2 gap-y-4 pr-4 flex-col">
                ...
                <div class="flex justify-center text-white items-center text-center">
                    <div class="border-r border-s-gray-100 py-5">
                        <span class="text-first-orange px-4 py-1 text-6xl font-bold">
                            <?php echo e($entreprise->projets->count() ?? 0); ?>
                    ...
                    <div class="border-l border-s-gray-100 py-5">
                        <span class="text-first-orange px-4 py-1 text-6xl font-bold">
                            <?php echo e($entreprise->demandes->count() ?? 0); ?>
            ...
            <div class="overflow-hidden shadow-xl sm:rounded-lg mt-0">
                ...
                <div class="">
                    <?php if($entreprise->projets->count() > 0): ?>
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <table class="w-full bg-white text-sm text-left text-gray-500 ">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $entreprise->projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-b border-gray-200 ">
                                            <td
                                                class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50 ">
                                                <?php echo e($projet->type_agrement); ?>

                                            </td>
                                            <td class="px-3 py-3">
                                                <?php if($projet->est_agree): ?>
                                                    <span
                                                        class="px-3 py-1 text-xs font-semibold leading-tight text-green-700 bg-green-100 rounded ">
                                                        Oui
                                                    </span>
            ...
            <div class="overflow-hidden sm:rounded-lg mt-0">
                ...
                <div class="">
                    <?php if($entreprise->demandes->count() > 0): ?>
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <table class="w-full bg-white text-sm text-left text-gray-500 ">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $entreprise->demandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-b border-gray-200 ">
                                            <td
                                                class="px-3 py-2 font-medium whitespace-nowrap bg-gray-50">
                                                <?php echo e($demande->libelle); ?>

                                            </td>
                                            <td class="px-3 py-2">
                                                <?php echo e($demande->date_depot); ?>


                                            </td>

                                            <td class="px-3 py-2">
                                                <?php echo e($demande->typeDemande->code ?? ' - '); ?>
                                            ...
                                            <td class="px-2 py-2">
                                                <div
                                                    ...
                                                    <a href="<?php echo e(route('demande.show', $demande->id)); ?>"
                                                        class="text-black font-bold flex py-1 items-center">
                                                        Voir&nbsp;
                                                        <svg width="18" height="14" viewBox="0 0 18 14"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/entreprises/detail-entreprise.blade.php ENDPATH**/ ?>