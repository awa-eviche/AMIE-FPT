<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model(new \App\Models\Actualite(), ['route' => ['actualite.store'], 'role' => 'form', 'class' => 'apix-form', 'files' => 'true']); ?>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            <div class="md:container md:mx-auto">
                <h2 class="text-first-orange text-1xl py-2">Ajouter une actualité</h2>
                <hr>
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <?php echo Form::text('title', null, ['id' => 'title', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']); ?>
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        <label for="main_pic"
                            ...
                            principale</label>
                        <?php echo Form::file('image', ['id' => 'image', 'class' => $inputClass.$tclass,'required' => 'true' , 'placeholder'=>'Choisir une image']); ?>
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <?php echo Form::text('contenu', null, ['id' => 'richEd', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']); ?>
...
<?php echo $__env->make('layouts.v1.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/amie-fpt/resources/views/actualite/create.blade.php ENDPATH**/ ?>