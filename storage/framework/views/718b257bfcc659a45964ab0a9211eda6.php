...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Liste des Types de Demandes')); ?>
    ...
    <div class="container p-2 rounded">
        <div class="flex justify-between items-center mb-3">
            <h2 class="font-bold text-first-orange">Liste des Types de Demandes</h2>
            <div class="flex justify-end">
                <a href="<?php echo e(route('type_demande.create')); ?>" class="flex bg-first-orange hover:bg-cyan-700 text-white font-bold py-1 text-sm px-4 rounded">
                    <span class="mr-2">Nouveau type</span>
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs p-0">
            <div class="w-full overflow-x-scroll p-0">
                <table class="w-full border-t">
                    <thead>
                        <tr class="text-xs font-black tracking-wide text-left text-maquette-gris uppercase border-b bg-first-orange py-2">
                    ...
                    <tbody class="bg-white divide-y">
                        <?php $__currentLoopData = $typeDemandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeDemande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-gray-700">
                                <td class="px-4 py-3 border-b"><?php echo e($typeDemande->code); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($typeDemande->libelle); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($typeDemande->description); ?></td>
                                <td class="px-4 py-3 border-b">
                                    <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">

                                        <a href="<?php echo e(route('type_demande.show', $typeDemande->id)); ?>" class="text-maquette-gris">
                                        ...
                                        <a href="<?php echo e(route('type_demande.edit', $typeDemande->id)); ?>" class="text-purple-600">
                                        ...
                                        <form class="text-center" action="<?php echo e(route('type_demande.destroy', $typeDemande->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/type_demande/index.blade.php ENDPATH**/ ?>