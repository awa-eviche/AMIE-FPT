...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('anneeacademique.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter une année académique</span>
            ...
            <table class="w-full border-t mb-3">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-4">Annee 1</th>
                        <th class="px-4 py-4">Annee 2</th>
                        <th class="px-4 py-4">Date de début</th>
                        <th class="px-4 py-4">Date de fin</th>
                        <th class="px-4 py-4">Lancée ?</th>
                ...
                <tbody class="bg-white divide-y ">
                    <?php
                        $num = 1;
                    ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $anneeacademiques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anneeacademique): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            
                       
                                    <td class="px-6 py-3 border-b"><?php echo e($num); ?></td> 
                                    <td class="px-6 py-3 border-b"><?php echo e($anneeacademique->code ?? ' - '); ?></td>
                                    <td class="px-6 py-3 border-b"><?php echo e($anneeacademique->annee1 ?? ' - '); ?></td>
                                    <td class="px-6 py-3 border-b"><?php echo e($anneeacademique->annee2 ?? ' - '); ?></td>
                                    <td class="px-6 py-3 border-b"><?php echo e($anneeacademique->dateDebut ?? ' - '); ?></td>
                
                <td class="px-6 py-3 border-b"><?php echo e($anneeacademique->dateFin?? '-'); ?></td>

                <td class="px-6 py-3 border-b"><?php echo e($anneeacademique->is_open == 1 ? "OUI" : "NON"); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('anneeacademique.show', $anneeacademique->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('anneeacademique.edit', $anneeacademique->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                    ...
                    'route' => array('anneeacademique.destroy', $anneeacademique->id))); ?>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/anneeacademique/liste-anneeacademique.blade.php ENDPATH**/ ?>