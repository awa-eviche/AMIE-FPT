<div>
    <div class="flex mb-4 text-sm font-bold bg-white px-4 py-3 rounded-sm">
        ...
        <p><a href="<?php echo e(route('liste.index')); ?>">Page d'acceuil</a>
    ...
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            <a href="<?php echo e(route('faqs.create')); ?>"
    ...
    <div class="w-full rounded-lg shadow-xs p-0">
        ...
        <div class="text-sm w-full p-0 overflow-x-auto">
            <table class="w-full border-t mb-3">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="text-gray-700 ">
                        <td class="px-4 py-3 border-b"><?php echo e($question->question ?? ' - '); ?></td>
                        <td class="px-4 py-3 border-b"><?php echo e($question->priority ?? ' - '); ?></td>
                        <td class="px-4 py-3 border-b">
                                <span
                                    class="py-2 px-4 <?php echo e($question->status == 'active' ? 'bg-green-100 text-green' : 'bg-red-100 text-red'); ?> rounded">
                                    <?php echo e($question->status == 'active' ? 'Activé' : 'Désactivé'); ?>

                                </span>
                        </td>
                        <td class="px-4 py-3 border-b flex justify-end">
                            <a href="<?php echo e(route('faqs.edit', $question->id)); ?>"
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/page-acceuil/faq.blade.php ENDPATH**/ ?>