...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouvelle compétence')); ?>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded">
        <form action="<?php echo e(route('competence.store')); ?>" method="POST"
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'code','name' => 'code','type' => 'text','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('code')),'required' => true,'autofocus' => true,'class' => 'block w-full enlever_shadow rounded px-2 py-0.75 text-sm border-2 focus:border-first-orange']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'nom','name' => 'nom','type' => 'text','value' => old('nom'),'required' => true,'class' => 'block w-full enlever_shadow rounded px-2 py-0.75 text-sm border-2 focus:border-first-orange']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'nom','name' => 'nom','type' => 'text','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('nom')),'required' => true,'class' => 'block w-full enlever_shadow rounded px-2 py-0.75 text-sm border-2 focus:border-first-orange']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php $component->withAttributes(['id' => 'type','name' => 'type','required' => true,'class' => 'block w-full enlever_shadow rounded px-2 py-0.75 text-sm border-2 focus:border-first-orange']); ?>
                            ...
                            <option value="generale" <?php echo e(old('type') == 'generale' ? 'selected' : ''); ?>>Générale</option>
                            <option value="particuliere" <?php echo e(old('type') == 'particuliere' ? 'selected' : ''); ?>>Particulière</option>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('parametrage.Competence.CreateCompetence');

$__html = app('livewire')->mount($__name, $__params, 'lw--85212151-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/competence/create.blade.php ENDPATH**/ ?>