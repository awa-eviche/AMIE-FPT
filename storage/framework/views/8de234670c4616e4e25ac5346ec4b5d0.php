...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_etablisement')): ?>
            <a href="<?php echo e(route('departement.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
...
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> départements trouvés</span></div>
            ...
            <table class="w-full border-t mb-3">
                ...
                <tbody class="bg-white divide-y ">
                            <?php
                                $num = 1;
                            ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $departements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            <td class="px-6 py-3 border-b"><?php echo e($num); ?></td>
                            <td class="px-6 py-3 border-b"><?php echo e($departement->code ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($departement->libelle ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('departement.show', $departement->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('departement.edit', $departement->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/departements/liste-departement.blade.php ENDPATH**/ ?>