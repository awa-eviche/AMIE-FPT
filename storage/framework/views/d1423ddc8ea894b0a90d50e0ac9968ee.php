...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouveau département')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white p-3 bg-white">
        <p>
            ...
            <a href="<?php echo e(route('departement.index')); ?>"  class="text-maquette">Référentiel</a>
              <span class="mx-2 text-maquette">/</span>
        <p> <a href="<?php echo e(route('departement.index')); ?>" >Département  </a>
            
            <span class="mx-2 text-maquette">/</span>
        </p>

        <p class="text-first-orange">Nouveau département</p>
        </p>
      
    </div>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded" >
        <!-- <div class="w-full mx-auto max-w-2xl"> -->
            <!-- <h3 class="bg-dark" style="padding:10px; margin-left:10px;"> <b> Formulaire d'ajout d'une région </b></h3> -->
            <form action="<?php echo e(route('departement.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/departements/create.blade.php ENDPATH**/ ?>