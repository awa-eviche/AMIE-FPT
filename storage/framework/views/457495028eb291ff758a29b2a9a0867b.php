...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Flux de traitement')); ?>
                ...
                <div class="max-full mx-auto">
                    <div class="overflow-hidden shadow-xl sm:rounded-lg">
                        <div class="flex justify-between items-center">
                            <p class="font-bold py-2 m-4 text-first-orange text-xl">Flux de traitement de la demande</p>

                            <div class="flex justify-end m-4 bg-first-orange hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded items-center">
                                <a href="<?php echo e(route('workflow.create')); ?>" class="mr-2 text-sm">
                                ...
                                <table class="w-full border-t">
                                    <thead>
                                        <tr class="text-xs font-black tracking-wide text-left text-maquette-gris uppercase border-b bg-first-orange">
                                            ...
                                            <th class="px-4 py-4">Type demande</th>
                                    ...
                                    <tbody class="bg-white divide-y">
                                        <?php $__currentLoopData = $workflows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workflow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="text-gray-700 ">
                                                <td class="px-4 py-3 border-b"><?php echo e($workflow->code); ?></td>
                                                <td class="px-4 py-3 border-b"><?php echo e($workflow->libelle); ?></td>
                                                <td class="px-4 py-3 border-b"><?php echo e($workflow->description); ?></td>
                                                <td class="px-4 py-3 border-b"><?php echo e($workflow->typeDemande->libelle); ?></td>
                                                <td class="px-4 py-3 border-b">
                                                    <?php if($workflow->estActif): ?>
                                                ...
                                                <td class="px-4 py-3 border-b">
                                                    <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                                        <a href="<?php echo e(route('workflow.show', $workflow->id)); ?>" class="text-maquette-gris">
                                                        ...
                                                        <a href="<?php echo e(route('workflow.edit', $workflow->id)); ?>" class="text-purple-600">
                                                        ...
                                                        <form class="text-center" action="<?php echo e(route('workflow.destroy', $workflow->id)); ?>" method="POST">
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/workflows/index.blade.php ENDPATH**/ ?>