...
<?php echo Form::model(new \App\Models\FrontActualite(), ['route' => ['store.actualite'], 'role' => 'form', 'class' => 'apix-form', 'files' => 'true']); ?>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            <div class="md:container md:mx-auto">
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('index.actualite')); ?>" class="text-blue-500 hover:underline">&larr; Retour à la liste des
                        actualités</a>
                </div>
                <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        <label for="titre" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Titre</label>
                        <?php echo Form::text('actualite_titre', null, ['id' => 'actualite_titre', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']); ?>

                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <label for="main_pic" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Image principale</label>
                        <?php echo Form::file('actualite_main_pic', ['id' => 'actualite_main_pic', 'class' => $inputClass,'required' => 'true' , 'placeholder'=>'Choisir une image']); ?>
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        <?php echo Form::text('actualite_corps', null, ['id' => 'richEd', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']); ?>
...
<?php echo $__env->make('layouts.v1.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/amie-fpt/resources/views/admin/front/actualites/create.blade.php ENDPATH**/ ?>