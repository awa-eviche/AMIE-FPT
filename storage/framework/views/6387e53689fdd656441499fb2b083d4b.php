<div class="pr-5">
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('ief.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
...
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> ief trouvés</span></div>
        ...
        <div class="text-sm w-full p-0">
            <table class="w-full border-t mb-3">
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    $num = 1;
                    ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $iefs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ief): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="text-gray-700 ">


                        <td class="px-6 py-3 border-b"><?php echo e($num); ?></td>
                        <td class="px-6 py-3 border-b"><?php echo e($ief->nom ?? ' - '); ?></td>

                        <td class="px-6 py-3 border-b"><?php echo e($ief->email ?? '-'); ?></td>

                        <td class="px-6 py-3 border-b"><?php echo e($ief->telephone ?? '-'); ?></td>

                        <td class="px-6 py-3 border-b"><?php echo e($ief->adresse ?? '-'); ?></td>

                        <td class="px-6 py-3 border-b"><?php echo e($ief->ia->nom ?? '-'); ?></td>
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute z-50 mt-1 w-48 rounded-md shadow-lg origin-top-right right-0" @click="open = false" style="display: none;">
                                    <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                        <div class="border shadow-md py-2 text-center">
                                            <a href="<?php echo e(route('ief.show', $ief->id)); ?>" class="text-purple-600">Voir
                                            </a>
                                        </div>
                                        <div class="border shadow-md py-2 text-center">
                                            <a href="<?php echo e(route('ief.edit', $ief->id)); ?>" class="text-purple-600">
                                                Modifier
                                            </a>
                                        </div>
                                        <div class="border shadow-md py-2 text-center">
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/ief/liste-ief.blade.php ENDPATH**/ ?>