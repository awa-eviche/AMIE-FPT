...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        ...
        <p class="text-first-orange">Nouvelle classe</p>
        </p>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('classe.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex-grow mb-4 mr-2">
                            <label for="annee_academique_id">Sélectionner une annee academique :</label>
                            <select class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" id="annee_academique_id" name="annee_academique_id">
                                <option value="">Choisir une annee academique</option>
                                <?php $__currentLoopData = $anneeacademiques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anneeacademique): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($anneeacademique->id); ?>"><?php echo e($anneeacademique->annee1 . '-' . $anneeacademique->annee2); ?></option>
...
<?php $component->withAttributes(['for' => 'modalite']); ?>
                            Modalite pedagogique du metier <span class="text-red-500">*</span>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald8ba2b4c22a13c55321e34443c386276)): ?>
<?php $attributes = $__attributesOriginald8ba2b4c22a13c55321e34443c386276; ?>
...
[$__name, $__params] = $__split('Classe.CreateClasse');

$__html = app('livewire')->mount($__name, $__params, 'lw--643356533-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/classe/createFAOLD.blade.php ENDPATH**/ ?>