    ...
    <div class="w-full mx-auto">
        <form wire:submit.prevent class="bg-white rounded px-4 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4 max-w-md mx-auto">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['donnees.libelle'];
            ...
            <div class="shadow p-4 border rounded bg-white shadow">
                ...
                <div class="flex flex-wrap mb-3 justify-evenly">
                    <div class="w-[400px]">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nomFichier'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mt-5 p-4 shadow border rounded bg-white shadow">
                ...
                <ul class="list-disc pl-4 flex flex-wrap">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/demandes/edit-demande.blade.php ENDPATH**/ ?>