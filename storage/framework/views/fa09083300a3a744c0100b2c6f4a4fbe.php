            ...
            <div class="lg:w-full flex justify-between items-center px-4 py-2">
                <div>
                    <span class="text-gray-700 font-bold text-lg font-medium">
                        <a href="<?php echo e(route('inspecteur.index')); ?>"><span><i class="fa fa-angle-left"></i></span> </a>
                        <span class="text-gray-700 text-xl font-bold pl-2">
                        <?php echo e($inspecteur->prenom); ?> <?php echo e($inspecteur->nom); ?></span></span>
                </div>
                <div>
        ...
        <div class="flex md:w-full  flex-col">
            <div class="rounded-lg shadow-sm px-8 py-5 bg-white">
                <div class="flex justify-between text-black items-center">
                    ...
                    <a class="text-orange-600 bg-orange-100 text-sm rounded-md shadow-md px-4 py-1" href="<?php echo e(route('inspecteur.edit', $inspecteur->id)); ?>">
                        Modifier
                    </a>
                </div>
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                        <span>Prenom : </span>
                        <span>
                            <b><?php echo e($inspecteur->prenom ?? ' Non renseigné '); ?></b>
                        </span>
                    </div>
                    <div>
                        <span>Nom : </span>
                        <span>
                            <b><?php echo e($inspecteur->nom ?? 'Non renseigné'); ?></b>
                        </span>
                    </div>
                </div>
                ...
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                        <span>Telephone : </span>
                        <span>
                            <b><?php echo e($inspecteur->telephone ?? ' Non renseigné '); ?></b>
                        </span>
                    </div>
                    <div>
                        <span>Email : </span>
                        <span>
                            <b><?php echo e($inspecteur->email ?? 'Non renseigné'); ?></b>
                        </span>
                    </div>
                </div>
                ...
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                        ...
                        <span>
                            <b><?php echo e($inspecteur->specialite ?? ' Non renseigné '); ?></b>
                        </span>
                    </div>
                    <div>
                        <span>IA : </span>
                        <span>
                            <b><?php echo e($inspecteur->ia->nom ?? 'Non renseigné'); ?></b>
                        </span>
                    </div>
                </div>
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                        <span>IEF : </span>
                        <span>
                            <b><?php echo e($inspecteur->ief->nom ?? 'Non renseigné '); ?></b>
                        </span>
                    </div>
...
</div><?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/inspecteur/detail-inspecteur.blade.php ENDPATH**/ ?>