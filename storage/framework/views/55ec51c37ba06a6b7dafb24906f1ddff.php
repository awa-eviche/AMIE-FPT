    ...
    <div class="container mx-auto">
        <div class="bg-white shadow p-6 rounded-sm">
            <div class="flex items-center justify-between bg-gray-200 p-1 mt-2">
                ...
                <a href="<?php echo e(route("etat_workflow.edit", $etatWorkflow->id)); ?>" class="flex items-center justify-end bg-first-orange hover:bg-first-orange text-white px-2 py-1 rounded text-sm" wire:click="setEtatRejet">
            ...
            <div class="shadow p-6 rounded-sm">
                <div class="mt-4 mb-2 flex ">
                    ...
                    <div class="w-2/3">
                        <span class="text-grey-600"><?php echo e($etatWorkflow->position); ?></span>
                    </div>
                </div>
                <hr>
                ...
                <div class="mt-4 mb-2 flex ">
                    ...
                    <div class="w-2/3">
                        <span class="text-grey-600"><?php echo e($etatWorkflow->code); ?></span>
                    </div>
                </div>
                <hr>
                ...
                <div class="mt-4 mb-2 flex ">
                    ...
                    <div class="w-2/3">
                        <span class="text-grey-600"><?php echo e($etatWorkflow->libelle ?? " -"); ?></span>
                    </div>
                </div>
                <hr>
                <div class="mt-4 mb-2 flex ">
                    ...
                    <div class="w-2/3">
                        <span class="text-grey-600"><?php echo e($etatWorkflow->status ?? " - "); ?></span>
                    </div>
                </div>
                <hr>
                <div class="mt-4 mb-2">
                    ...
                    <p class="shadow border p-2 text-grey-600 rounded-sm mb-2">
                        <?php echo e($etatWorkflow->description); ?>
                ...
                <div class="mt-4 mb-2 flex ">
                    ...
                    <div class="w-2/3">
                        <span class="text-grey-600">
                            <?php if($etatWorkflow->est_rejetable): ?>
                ...
                <div class=" mt-2">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="etat_suivant_id" wire:model="etat_suivant_id" class="form-input rounded-md border-gray-300 shadow-sm block w-full">
                            ...
                            <?php $__currentLoopData = $allEtatWorkflow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($etat->id); ?>"><?php echo e($etat->position . ' - ' . $etat->libelle); ?></option>
            ...
            <?php else: ?>
                <div class="shadow p-6 rounded-lg">
                    <div class="mt-4 mb-2 flex ">
                        ...
                        <div class="w-2/3">
                            <span class="text-grey-600"><?php echo e($etatWorkflow->bouton_suivant); ?></span>
                        </div>
                    </div>
                    <?php if($etatWorkflow->etatSuivant): ?>
                        <div class="mt-4 mb-2 flex ">
                            <div class="w-1/3 flex items-end justify-end pr-2">
                                <strong class="text-black">État Suivant :</strong>
                            </div>
                            <div class="w-2/3">
                                <span class="text-grey-600"><?php echo e($etatWorkflow->etatSuivant->libelle); ?></span>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="mt-4 mb-2 flex ">
            ...
            <?php else: ?>
                <div class="shadow p-6 rounded-lg">
                    <div class="mt-4 mb-2 flex ">
                        ...
                        <div class="w-2/3">
                            <span class="text-grey-600"><?php echo e($etatWorkflow->bouton_rejet); ?></span>
                        </div>
                    </div>
                    <?php if($etatWorkflow->etatRejet): ?>
                        <div class="mt-4 mb-2 flex ">
                            <div class="w-1/3 flex items-end justify-end pr-2">
                                <strong class="text-black">État Rejet :</strong>
                            </div>
                            <div class="w-2/3">
                                <span class="text-grey-600"><?php echo e($etatWorkflow->etatRejet->libelle); ?></span>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="mt-4 mb-2 flex ">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/detail-etat.blade.php ENDPATH**/ ?>