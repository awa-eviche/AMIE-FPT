                ...
                <div class="flex flex-col lg:flex-row gap-6 mt-4">
                    ...
                    <div class="lg:w-2/3 border shadow p-4 rounded bg-gray-100">
                        ...
                        <div class="flex justify-between gap-4 mb-6">
                            ...
                            <form action="<?php echo e(route('apprenant.import', ['classe' => $classe->id])); ?>" method="POST" enctype="multipart/form-data"
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/classe/showfaold.blade.php ENDPATH**/ ?>