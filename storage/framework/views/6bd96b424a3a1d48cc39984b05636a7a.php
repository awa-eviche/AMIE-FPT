...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Dossier: ')); ?><?php echo e($categoryFile->libelle); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        ...
        <p class="text-first-orange">Dossier:<?php echo e($categoryFile->libelle); ?></p>
        </p>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('crate.document')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/amie-fpt/resources/views/categoryDocument/show.blade.php ENDPATH**/ ?>