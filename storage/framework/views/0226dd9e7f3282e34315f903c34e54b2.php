<div class="p-4">
    ...
    <?php $__errorArgs = ['apprenantsSelectionnes'];
    ...
    <?php if($currentClasse && $annee_academique_id): ?>
        ...
        <?php if(count($admis) > 0): ?>
            ...
            <table class="table-auto w-full bg-white shadow rounded mb-6">
                ...
                <tbody>
                    <?php $__currentLoopData = $admis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b">
                            <td class="px-4 py-2">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/reinscription/liste-admis.blade.php ENDPATH**/ ?>