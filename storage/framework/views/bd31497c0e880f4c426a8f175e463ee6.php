<div class="bg-white shadow rounded-sm w-full p-4">
    ...
    <div class="w-full mx-auto">
        <form class="bg-white shadow-md rounded pt-6 pb-8 mb-4" action="<?php echo e(route('apprenant.update', $apprenant->id)); ?>" method="POST">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/apprenant/edit-apprenant.blade.php ENDPATH**/ ?>