<div class="w-full">
    ...
    <div class="mb-3">
        ...
        <div class="mt-4 w-full p-2 text-center mb-5">
            <?php if($demandesOfThisReunion->count() > 0): ?>
                ...
                <div class="relative overflow-scroll shadow-md sm:rounded-lg">
                    <table class="w-full bg-white text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $demandesOfThisReunion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-b border-gray-200 ">
                                    <td class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50">
                                        <?php echo e($demande->id ?? " -"); ?>

                                    </td>
                                    <td class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50 text-center">
                                        <?php echo e(date('d-m-Y',strtotime($demande->date_depot) ?? " ")); ?>

                                    </td>
                                    <td class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50 text-center">
                                        <?php echo e($demande->type_demande_libelle ?? " -"); ?>

                                    </td>
                                    <td class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50 text-center">
                                        <?php echo e($demande->nom_entreprise ?? " -"); ?>

                                    </td>
                                    <td class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50 text-center">
                                        <span class="bg-gray-200 py-2 px-3 rounded">
                                            <?php echo e($demande->etat_libelle); ?>
                                    ...
                                    <td class="px-1 py-2 w-24">
                                        <div class="flex justify-center rounded items-center text-sm shadow-xl p-1 bg-gray-200">
                                            ...
                                            <?php if($autoriser): ?>
                                                <a wire:click="detacher(<?php echo e($demande->id); ?>)" class="cursor-pointer text-maquette-gris ml-5">
                ...
                <div class="flex justify-between mb-3">
                    ...
                    <div class="relative overflow-scroll shadow-md sm:rounded-lg">
                        <table class="w-full bg-white text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $unSelectedDemande; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b border-gray-200 ">
                                        <?php if($modifying): ?>
                                            <td class="px-3 py-2">
                                                <input type="checkbox" wire:model="selection" value="<?php echo e($demande->id); ?>">
                                            </td>
                                        <?php endif; ?>
                                        <td class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50">
                                            <?php echo e($demande->id ?? " -"); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/reunions/manage-reunion-demande.blade.php ENDPATH**/ ?>