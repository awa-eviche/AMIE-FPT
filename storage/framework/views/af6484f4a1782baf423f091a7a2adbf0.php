...
<?php endif; ?>
            <select wire:model="filiere" wire:change="onFiliereChange" wire:ignore class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="filiere_id">
                ...
                <?php $__currentLoopData = $filiereFromBD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filiere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
            <select wire:model="niveau" wire:change="onNiveauChange" class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="niveau_id">
                ...
                <?php $__currentLoopData = $niveauFromBD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="grid grid-cols-2 md:grid-cols-2">
        <table class="table-auto w-full">
            ...
            <tbody>
    <?php if(isset($datasets) && is_array($datasets)): ?>
        <?php
            $num = 1;
        ?>
        <?php $__currentLoopData = $datasets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donnee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
...
</div><?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/param/demande-ouverture-etablissement.blade.php ENDPATH**/ ?>