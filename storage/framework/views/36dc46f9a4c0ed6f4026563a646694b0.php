...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        ...
        <p class="text-first-orange">Edition d'un type de demande</p>
    </div>

    <div class="bg-white shadow rounded-sm w-full">
        <div class="w-full mx-auto max-w-2xl">
            <form action="<?php echo e(route('type_demande.store')); ?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/type_demande/create.blade.php ENDPATH**/ ?>