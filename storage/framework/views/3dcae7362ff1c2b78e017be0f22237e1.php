<div>
    ...
    <div class="flex justify-end">
        <button wire:click = "toggleAffecting" <?php echo e($disabled ? 'disabled' : ''); ?> class="flex items-center bg-green-800 hover:bg-green-900 hover:shadow-xl py-2 px-4 rounded text-white font-bold ">
            <span class="mr-2">
                Affecter la demande
            </span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['wire:model' => 'affecting','maxWidth' => '7xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'affecting','maxWidth' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('7xl')]); ?>
        ...
        <div class="p-3 mx-auto shadow mt-4" style="min-height : 80vh">
                                ...
                                <?php $__currentLoopData = $instructeurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructeur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-gray-700">
                                        <td class="px-3 mx-auto py-3 border-b font-bold">
                                            <input type="radio" name="selectionedAgentId" value="<?php echo e($instructeur->userable_id); ?>" id="<?php echo e($instructeur->userable_id); ?>" wire:model="selectionedAgentId">
                                        </td>
                                        <td class="px-3 mx-auto py-3 border-b font-bold"><?php echo e($instructeur->id ?? " "); ?></td>
                                        <td class="text-center px-1 py-3 border-b font-bold text-maquette-gris"><?php echo e($instructeur->prenom?? "- "); ?></td>
                                        <td class="text-center px-1 py-3 border-b font-bold"><?php echo e($instructeur->nom ?? " - "); ?></td>
                                        <td class="text-center px-1 py-3 border-b font-bold text-maquette-gris"><?php echo e($instructeur->email ?? "-"); ?></td>
                                        <td class="text-center px-1 py-3 border-b font-bold"><?php echo e($instructeur->date_naissance ?? " - "); ?></td>
                                        <td class="text-center px-1 py-3 border-b font-bold"><?php echo e($instructeur->telephone ?? " - "); ?></td>
                                        <td class="text-center px-1 py-3 border-b font-bold"><?php echo e($instructeur->role_name ?? " - "); ?></td>
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <div class="flex">
                        ...
                        <?php if(!$etat->code == "recep_sign_valid"): ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/etude-demande/affecter-demande.blade.php ENDPATH**/ ?>