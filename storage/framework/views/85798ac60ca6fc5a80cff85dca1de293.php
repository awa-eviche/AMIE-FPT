...
<?php endif; ?>
    <select id="classe_examen" name="classe_examen" 
        ...
        <option value="0" <?php echo e(old('classe_examen') == '0' ? 'selected' : ''); ?>>Non</option>
        <option value="1" <?php echo e(old('classe_examen') == '1' ? 'selected' : ''); ?>>Oui</option>
    </select>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2048683525-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\AMIE-FPT\resources\views/classe/create.blade.php ENDPATH**/ ?>