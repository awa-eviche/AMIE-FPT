    ...
    <div class="w-full rounded-lg shadow-xs p-0">
        <div class="flex flex-col sm:flex-row w-full justify-between sm:items-center">
            ...
            <div class="text-poppins_black font-bold text-lg">
                <?php if($apprenant && $apprenant->apprenant && $apprenant->apprenant->user): ?>
            ...
            <?php if($count > 10): ?>
                <div class="flex justify-start items-center mt-5">
                    <button type="button"
                            ...
                            wire:click="prev"
                            <?php if($startLimit==0): ?> disabled <?php endif; ?>>
                    ...
                    <span class="text-md text-black mx-3">
                        <?php echo e(min($count, $startLimit+1)); ?>

                        à
                        <?php echo e(min($startLimit+10, $count)); ?>

                        sur <?php echo e($count); ?>
                    ...
                    <button type="button"
                            class="bg-white px-4 rounded-md border-white py-3 flex text-black text-sm text-center shadow-lg items-center"
                            wire:click="next"
                            <?php if(($startLimit+10) >= $count): ?> disabled <?php endif; ?>>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/apprenant/competence/evaluationOld.blade.php ENDPATH**/ ?>