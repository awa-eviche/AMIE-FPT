            ...
            <div class="flex flex-col lg:flex-row items-center">
                <div class="w-full lg:w-1/2 lg:pr-10 mb-10 lg:mb-0 animate-fade-in-up">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 items-start">
                        <a href="<?php echo e(url('/request')); ?>" class="btn-primary-custom">
                ...
                <div class="w-full lg:w-1/2 mt-10 lg:mt-0 animate-fade-in-up" style="animation-delay: 0.2s;">
                    <img class="w-full max-w-2xl mx-auto rounded-lg shadow-xl" src="<?php echo e(asset('frontAssets2/images/amiefptsn2.png')); ?>" alt="Illustration AMIE-FPT" />
                </div>
            </div>
        </div>
    </section>
...
</html><?php /**PATH C:\env_dev\projets\AmieFPT\AMIE-FPT\resources\views/welcome.blade.php ENDPATH**/ ?>