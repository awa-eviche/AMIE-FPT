        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div>
                ...
                <select wire:model="metier_id" wire:change="$refresh"
                    ...
                    <?php $__currentLoopData = $metiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                ...
                <select wire:model="niveau_etude_id" wire:change="$refresh"
                        class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 enlever_shadow" required>
                    <option value="">-- Sélectionner --</option>
                    <?php $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/parametrage/element-competence/element-competence-multi-fixed.blade.php ENDPATH**/ ?>