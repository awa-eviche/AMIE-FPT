  ...
  <div class="layout">
    ...
    <div class="map-card">
      ...
      <div class="map-container" id="mapContainer">
        <img id="carteImage"
             src="<?php echo e(asset('carte.gif')); ?>"
        ...
        <map name="carte_senegal">
          <?php $__currentLoopData = $departements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <area
              alt="<?php echo e($departement->libelle); ?>"
              title="<?php echo e($departement->libelle); ?>"
              href="#"
              data-dep-id="<?php echo e($departement->id); ?>"
              coords="<?php echo e($departement->coords); ?>"
              shape="poly"
              aria-label="D̩partement <?php echo e($departement->libelle); ?>, <?php echo e($departement->etablissements->count()); ?> Etablissements"
              tabindex="0">
...
<script>
  ...
  <?php $__currentLoopData = $departements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    establishments[<?php echo json_encode($d->libelle, 15, 512) ?>] = <?php echo json_encode($d->etablissements->pluck('nom')->values(), 15, 512) ?>;

    departments[<?php echo json_encode($d->id, 15, 512) ?>] = {
      id: <?php echo json_encode($d->id, 15, 512) ?>,
      name: <?php echo json_encode($d->libelle, 15, 512) ?>,
      etablissements: [
        <?php $__currentLoopData = $d->etablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          {
            id: <?php echo json_encode($e->id, 15, 512) ?>,
            nom: <?php echo json_encode($e->nom, 15, 512) ?>,
            tel: <?php echo json_encode($e->telephone, 15, 512) ?>,
            adresse: <?php echo json_encode($e->adresse, 15, 512) ?>,
           metiers: [
              <?php $__currentLoopData = $e->niveauEtudeEtablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                {
                  nom: <?php echo json_encode(optional($nee->niveauEtude->metier)->nom, 15, 512) ?>,
                  diplome: <?php echo json_encode(optional($nee->niveauEtude)->nom, 15, 512) ?>
                },
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ]
          },
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/carto.blade.php ENDPATH**/ ?>