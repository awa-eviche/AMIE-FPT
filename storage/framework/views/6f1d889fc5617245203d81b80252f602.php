...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        ...
        <p class="text-first-orange">Nouveau Métier</p>
        </p>
...
unset($__errorArgs, $__bag); ?>
 ...
 <label for="filiere_id">Sélectionner une filiere :</label>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/metier/createfa.blade.php ENDPATH**/ ?>