...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__(' Modification du secteur')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="<?php echo e(route('secteur.index')); ?>"  class="text-maquette">Accueil</a>
              <span class="mx-2 text-maquette">/</span>
            <a href="<?php echo e(route('secteur.index')); ?>"  class="text-maquette">Référentiel</a>
              <span class="mx-2 text-maquette">/</span>
        <p> <a href="<?php echo e(route('secteur.index')); ?>" >Secteur  </a>
            
            <span class="mx-2 text-maquette">/</span>
        </p>

        <p class="text-first-orange">Modification du Secteur</p>
        </p>
    ...
    <div class="rounded-sm w-full p-4 mt-2">
        ...
        <div class="rounded-sm w-full">
            <div class="w-full mx-auto max-w-6xl">
                <form action="<?php echo e(route('secteur.update', $secteur->id)); ?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/secteurs/edit.blade.php ENDPATH**/ ?>