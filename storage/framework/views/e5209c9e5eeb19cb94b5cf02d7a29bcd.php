    ...
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="#" data-modal-target="type-indicateur-modal" data-modal-toggle="type-indicateur-modal" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                ...
                </svg><span class="mx-2">Ajouter un type survey</span>
            </a>
        </div>
...
[$__name, $__params] = $__split('parametrage.typeindicateur.crate-type-indicateur');

$__html = app('livewire')->mount($__name, $__params, 'lw-545387850-0', $__slots ?? [], get_defined_vars());
        ...
        <div class="text-sm w-full p-0">
            <table class="w-full border-t mb-3">
                ...
                <tbody class="bg-white divide-y ">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $typeindicateur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            <td class="px-4 py-3 border-b"><?php echo e($type->code ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b ">
                                <?php echo e($type->libelle ?? ' - '); ?></td>
                                <td class="px-4 py-3 border-b ">
                                <?php echo e($type->description ?? ' - '); ?></td>
                            ...
                            <td class="px-4 py-3 border-b flex justify-center" style="position relative;left:1%;">
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <a data-modal-target="edit-type-indicateur-modal'<?php echo e($type->id); ?>'" data-modal-toggle="edit-type-indicateur-modal'<?php echo e($type->id); ?>'" href="#" class="text-purple-600" >
                                                    Modifier
                                                </a>
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="<?php echo e(route('typeIndicateur.destroy', $type->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                ...
                                <!-- Main modal -->
                                <div id="edit-type-indicateur-modal'<?php echo e($type->id); ?>'" tabindex="-1" aria-hidden="true" class="hidden w-auto bg-black bg-opacity-25 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-centermd:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <!-- Modal header -->
                                            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                                ...
                                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="edit-type-indicateur-modal'<?php echo e($type->id); ?>'">
                                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                                    </svg>
                                                    <span class="sr-only">Close modal</span>
                                            ...
                                            <!-- Modal body -->
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="bg-white pt-6 pb-8 mb-4" action="<?php echo e(route('typeIndicateur.update', $type->id )); ?>" method="POST">
                                                    ...
                                                    <div class="w-full sm:px-2 lg:px-4 ">
                                                        ...
                                                        <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                                            <div class="mb-4">
                                                                ...
                                                                <input value="<?php echo e($type->code); ?>" type="text"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <input value="<?php echo e($type->libelle); ?>" type="text"
                                                                    class="border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="flex justify-start items-center mt-5">
                ...
                <button wire:click="next" <?php echo e(($startLimit+10) >= $count ? 'disabled' : ''); ?> type="button" class="bg-white px-4 rounded-md border-white py-3 flex text-black text-sm text-center shadow-lg items-center">
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/parametrage/typeindicateur/liste-type-indicateur.blade.php ENDPATH**/ ?>