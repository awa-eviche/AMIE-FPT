            ...
            <div class="flex-1 lg:mr-32">
                <?php if(Auth()->user()->personnel && Auth()->user()->personnel->etablissement): ?>
                    <div class="text-xxl" style="color:#f7ac42; font-weight: bolder;">
                        <span class="text-poppins_black "><?php echo e(Auth()->user()->personnel->etablissement->nom); ?></span>
                    </div>
                <?php endif; ?>
                <span class="text-poppins" style="font-size:14px;">
                    Bonjour, <span class="text-poppins_black text-first-orange"><?php echo e(Auth()->user()->prenom.' '.Auth()->user()->nom); ?></span>
                </span>
                <p class="heure text-sm text-center sm:text-justify" >
                    <?php echo e($dateActuelle); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3610151359-0', $__slots ?? [], get_defined_vars());
...
?>
            &thinsp;&thinsp;<?php echo e(Auth()->user()->prenom.' '.Auth()->user()->nom); ?>&thinsp;
            <!-- Settings button -->
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
                    ...
                    <img class="w-10 h-10 rounded-full" src="<?php echo e(asset('backofficeAssets/build/images/imagepgi.svg')); ?>"
                        alt="MFP CI" />
                </button>
                <!-- User dropdown menu -->
                <div x-show="open" x-ref="userMenu"
                    ...
                    <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" role="menuitem"
                        class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary">
                        Déconnexion
                    </a>
            ...
            <div class="flex w-full justify-between">
                ...
                <div class="relative ml-auto" x-data="{ open: false }">
                    <button @click="open = !open" type="button" aria-haspopup="true"
                        ...
                        <img class="w-10 h-10 rounded-full" src="<?php echo e(asset('backofficeAssets/build/images/imagepgi.svg')); ?>"
                            alt="<?php echo e(Auth()->user()->prenom.' '.Auth()->user()->nom); ?>" />
                    </button>
...
<?php /**PATH C:\env_dev\projets\AmieFPT\AMIE-FPT\resources\views/layouts/v1/partials/_header.blade.php ENDPATH**/ ?>