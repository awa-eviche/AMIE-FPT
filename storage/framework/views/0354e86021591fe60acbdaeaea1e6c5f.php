...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Demande')); ?> N° <?php echo e($demandeDetails->id); ?>
    ...
    <div class="">
        <div class="max-w-10xl mx-auto">
            <div class="flex justify-between">
                <span class="text-black text-sm">Liste de mes demandes / <span class="text-orange-600"> Demande N° <?php echo e($demandeDetails->id); ?></span></span>
            </div>
                ...
                <div class="flex  w-2/3 gap-y-4 pr-4 flex-col">
                    <div class="rounded-lg shadow-sm px-8 py-5" style="background: var(--darkish-color-dark-1, #201E34);">
                        ...
                        <div class="flex justify-between text-white items-center mt-1 text-sm">
                            ...
                            <span>
                                <?php echo e(date('d/m/Y',strtotime($demandeDetails->date_depot))); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/promoteurs/demande.blade.php ENDPATH**/ ?>