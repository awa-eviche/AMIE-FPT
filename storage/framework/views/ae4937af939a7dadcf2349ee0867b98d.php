...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('critere.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter un critére</span>
    ...
    <form action="<?php echo e(route('critere.index')); ?>" method="GET">
    
    <div style="display: inline-block; margin-right: 10px;">
    <label for="selectedElementCompetenceMetier" style="text-align: center;">Filtrer par métier :</label><br>
    <select wire:model="selectedElement" wire:change="$refresh" id="selectElement" class="border border-gray-300 p-3 w-full focus:border-first-orange enlever_shadow rounded px-8 py-0.75 shadow-first-orange text-sm font-bold">
                    <option value="">Sélectionnez un élement de compétence</option>
...
<?php if($count): ?>
    <div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> critères trouvés</span></div>
<?php endif; ?>
    ...
    <div class="w-full rounded-lg shadow-xs p-0">
        <div class="text-sm w-full p-0">
            ...
            <thead>
					...
					<th class="px-4 py-4 text-white">Métier</th>
                                    <th class="px-4 py-4 text-white">Compétence</th>
                                    <th class="px-4 py-4 text-white">Element de compétence</th>
                        <!--th class="px-4 py-4 text-white">Code</th-->
                        <th class="px-4 py-4 text-white">Libellé</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $criteres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $critere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
			 <td class="px-4 py-3 border-b"><?php echo e($critere->competence->metier->nom ?? ' - '); ?></td>
                        <td class="px-4 py-3 border-b"><?php echo e($critere->competence->nom ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($critere->elementCompetence->nom ?? ' - '); ?></td>
                            <!--td class="px-4 py-3 border-b"><?php echo e($critere->code ?? ' - '); ?></td-->
                            <td class="px-4 py-3 border-b"><?php echo e($critere->libelle ?? ' - '); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('critere.show', $critere->id)); ?>"
                                                    class="text-purple-600">Visualiser
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('critere.edit', $critere->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <?php echo Form::open(array(
                                                    ...
                                                    <a href="#delete" class="text-purple-600 apix-delete" data-toggle="tooltip" title="Supprimer cette critere">
                                                        Supprimer
                                                    </a>
                                                <?php echo Form::close(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr><td colspan="8" class="px-4 py-4 font-bold text-lg text-center">Aucune donnée disponible</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/param/criterefa.blade.php ENDPATH**/ ?>