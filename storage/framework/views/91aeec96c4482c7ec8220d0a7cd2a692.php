        ...
        <?php if($membresReunion->count() > 0): ?>
            <div class="relative overflow-scroll shadow-md sm:rounded-lg">
                <table class="w-full bg-white text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $membresReunion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membreComite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-gray-200 ">
                                ...
                                <td class="px-1 py-2">
                                    <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                        ...
                                        <?php if($autoriser): ?>
                                            <a wire:click="retirerMembre(<?php echo e($membreComite->id); ?>)" class="cursor-pointer text-maquette-gris ml-5">
            ...
            <?php if($otherMembres->count() > 0): ?>
                ...
                <div class="relative overflow-scroll shadow-md sm:rounded-lg">
                    <table class="w-full bg-white text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $otherMembres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membreComite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-gray-200 ">
                                    <?php if($isModifying): ?>
                                        <td class="px-3 py-2">
                                            <input type="checkbox" wire:model="selection" value="<?php echo e($membreComite->id); ?>">
                                        </td>
                                    <?php endif; ?>
                                    <td
                                        class="px-3 py-3 font-medium whitespace-nowrap bg-gray-50 ">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/reunions/manage-membre-comite-reunion.blade.php ENDPATH**/ ?>