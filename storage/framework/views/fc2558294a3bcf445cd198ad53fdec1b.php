...
<?php $component->withAttributes([]); ?>
  ...
  <div class="mt-2">
    <!-- State cards -->
    <?php if(auth()->user()->hasRole([config('constants.roles.superadmin'), config('constants.roles.agent')])): ?>
      ...
      <a href="#" data-modal-target="super-etablissement-modal" data-modal-toggle="super-etablissement-modal" class="flex items-center p-4 bg-white rounded-md dark:bg-darker">
        ...
        <div>
            ...
            <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
              <span class="siffre" style="color:rgba(227, 142, 24, 1);"><?php echo e(auth()->user()->countEtablissement()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-0', $__slots ?? [], get_defined_vars());
...
?>
      ...
      <a  href="#" data-modal-target="etudiant-modal" data-modal-toggle="etudiant-modal" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
            ...
            <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
              <span class="siffre" style="color:rgba(227, 142, 24, 1);"><?php echo e(auth()->user()->countApprenant()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-1', $__slots ?? [], get_defined_vars());
        ...
        <!-- Main modal -->
          ...
          <a href="#" data-modal-target="filiere-modal" data-modal-toggle="filiere-modal" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div>
              ...
              <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                <span class="siffre;"><?php echo e(Auth::user()->getAllFormation()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
              </p>
            </div>
          </a>
          <!-- Main modal -->
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-2', $__slots ?? [], get_defined_vars());
...
?>
          ...
          <a href="#" data-modal-target="metier-modal" data-modal-toggle="metier-modal" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div>
              ...
              <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                <span class="siffre;"><?php echo e(Auth::user()->getAllMetier()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
              </p>
            </div>
          </a>
          <!-- Main modal -->
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-3', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <?php if(auth()->user()->hasRole(config('constants.roles.ia'))): ?>
    <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
      <!-- Value card -->
        ...
        <div>
          <p class="text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light" style="color: black;">
            Etablissements
               ...
               <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
              <span class="siffre" style="color:rgba(227, 142, 24, 1);"><?php echo e(auth()->user()->countEtablissementIA()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-5', $__slots ?? [], get_defined_vars());
...
?>
      ...
      <a  href="#" data-modal-target="etudiant-modal" data-modal-toggle="etudiant-modal" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <span class="siffre" style="color:rgba(227, 142, 24, 1);">
          <?php echo e(auth()->user()->countApprenantIA()); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-6', $__slots ?? [], get_defined_vars());
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
          ...
          <a href="#" data-modal-target="personnel-modal" data-modal-toggle="personnel-modal" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-900">
            ...
            <div>
              ...
              <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                <span class="siffre;"><?php echo e(auth()->user()->getAllPersonnel()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
              </p>
            </div>
          </a>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-7', $__slots ?? [], get_defined_vars());
...
?>
          ...
          <a href="#" data-modal-target="filiere-modal" data-modal-toggle="filiere-modal" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div>
              ...
              <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                <span class="siffre;"><?php echo e(Auth::user()->getAllFormationByEtablissement()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
              </p>
            </div>
          </a>
          <!-- Main modal -->
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-8', $__slots ?? [], get_defined_vars());
          ...
          <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div>
              <a  href="#" data-modal-target="etudiant-modal" data-modal-toggle="etudiant-modal">
                ...
                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                   <span class="siffre" style="color:rgba(227, 142, 24, 1);"><?php echo e(auth()->user()->getAllApprenantEtablissement()); ?></span>&thinsp;&thinsp; &thinsp; &thinsp; <span class="prctg" style="font-size: 10px;">
                </p>
              </a>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-9', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1251858656-10', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\env_dev\projets\AmieFPT\AMIE-FPT\resources\views/dashboard.blade.php ENDPATH**/ ?>