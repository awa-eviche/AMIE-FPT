...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('liste.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter une liste</span>
                ...
                <tbody class="bg-white divide-y ">
                    <?php $__empty_1 = true; $__currentLoopData = $listes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $liste): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            <td class="px-4 py-3 border-b"><?php echo e($liste->libelle ?? ' - '); ?></td>
                
                            <td class="px-4 py-3 border-b"><?php echo e($liste->valeur ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('liste.show', $liste->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('liste.edit', $liste->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="<?php echo e(route('liste.destroy', $liste->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/listes/liste-liste.blade.php ENDPATH**/ ?>