...
<body class="leading-normal tracking-normal text-white" style="font-family: poppins;overflow-x: hidden;font-size: 14px;">
    ...
    <section class=" border-b py-8" style="background-image: url(<?php echo e(asset('frontAssets2/images/Group\ 11033\ \(1\).svg')); ?>); background-repeat: no-repeat;">
...
[$__name, $__params] = $__split('demandes.new-demande', ['typeDemande' => $typeDemande]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1242237122-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <footer class="bg-white w-full" style="background-image: url(<?php echo e(asset('frontAssets2/images/Rectangle\ 39\ \(2\).svg')); ?>); font-weight: 200px; background-repeat: no-repeat;background-size: cover;">
        <div class="container mx-auto px-8 ">
            <div class="w-full flex flex-col md:flex-row py-6">
                <div class="flex-1 mb-6 text-black mr-11">
                    <a class="text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                        <img src="<?php echo e(asset('frontAssets2/images/LOGOFOOTERAMIFPT.png')); ?>" alt>
                    </a>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/request.blade.php ENDPATH**/ ?>