...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__("Visualisation de l'element de competence")); ?>
        ...
        <div class="w-full mx-auto max-w-6xl">
            <div class="rounded-lg shadow-sm px-8 py-5 bg-white">
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange py-2">
                           ...
                           href="<?php echo e(route('elementcompetence.edit', $elementcompetence->id)); ?>" style='position:relative;left: 68%;'>
                           Modifier
                       </a>
                               </h3>
                <div class="border border-gray-200 p-4">
                    <div class="flex justify-between text-black items-center mt-3 text-sm">
                        <div>
                            ...
                            <span>
                                <b><?php echo e($elementcompetence->code ?? ' - '); ?></b>
                            </span>
                        </div>
                        ...
                        <div>
                            ...
                            <span>
                                <b><?php echo e($elementcompetence->nom ?? ' -'); ?></b>
                            </span>
                        </div>
                   ...
                   <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                            ...
                            <span>
                                <b><?php echo e($elementcompetence->metier->nom ?? ' - '); ?></b>
                            </span>
                        </div>
                        <div>
                            <span>Matiere de l'element de competence  : </span>
                            <span>
                                <b><?php echo e($elementcompetence->matiere->nom ?? ' - '); ?></b>
                            </span>
                        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/elementcompetence/show.blade.php ENDPATH**/ ?>