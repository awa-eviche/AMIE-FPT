<div class="max-w-10xl mx-auto mt-5">
    <div class="flex flex-wrap justify-between">
        <div class="flex">
            <a href="#" class="mr-2 px-8 rounded-md py-0 flex text-white text-xs font-bold text-center bg-first-orange items-center">Tous</a>
            <a href="#" class="mx-2 px-5 rounded-md py-0 flex text-black text-xs font-bold text-center shadow-md bg-white items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <circle id="Ellipse 3" cx="5" cy="5" r="5" fill="#FDCE2F"/>
                </svg>
                <span class="mx-2">Demandes en cours</span>
            </a>
            <a href="#" class="mx-2 px-5 rounded-md py-0 flex text-black text-xs font-bold text-center shadow-md bg-white items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <circle id="Ellipse 3" cx="5" cy="5" r="5" fill="#2B883A"/>
                </svg>
                <span class="mx-2">Demandes validées</span>
            </a>
            <a href="#" class="mx-2 px-5 rounded-md py-0 flex text-black text-xs font-bold text-center shadow-md bg-white items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <circle id="Ellipse 3" cx="5" cy="5" r="5" fill="#EA333D"/>
                </svg>
                <span class="mx-2">Demandes rejetées</span>
            </a>
        </div>
        <div class="flex">
            <a href="#" class="mx-2 px-5 rounded-md py-0 flex text-black text-xs font-bold text-center shadow-md bg-white items-center">
            ...
            <div class="flex">
                ...
                <span href="#" class="bg-transparent border-transparent px-4 rounded-md py-2 flex text-black text-sm text-center  bg-white items-center">
            ...
            <div class="text-sm w-full p-0">
                <table class="w-full">
                  ...
                  <tr class="text-xs font-bold font-black tracking-wide text-left text-maquette-gris uppercase border-b bg-first-orange ">
                        <th class="px-4 py-4 font-bold">Entreprise</th>
                        <th class="px-4 py-4 font-bold">Nom investisseur</th>
                        <th class="px-4 py-4 font-bold">Date de dépôt</th>
                        <th class="px-4 py-4 font-bold">Type demande</th>
                        <th class="px-4 py-4 font-bold">Statut</th>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $demandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="bg-white">
                                <td class="px-4 py-4 font-bold"><?php echo e($demande->nom_entreprise); ?>  <?php echo e($demande->id); ?></td>
                                <td class="px-4 py-4">John Doe</td>
                                <td class="px-4 py-4 font-bold"><?php echo e(date('d/m/Y',strtotime($demande->date_depot))); ?></td>
                                <td class="px-4 py-4"><?php echo e($demande->type_demande_libelle); ?></td>
                                <td class="px-4 py-4 font-bold"><span class="text-center px-2 py-1 <?php echo e((($demande->etat_id == 0) ? 'text-red-600 bg-red-100' : (($demande->etat_id == 2) ? 'text-orange-600 bg-orange-100' : 'text-green-600	bg-green-100' ))); ?>"><?php echo e($demande->etat_libelle); ?></span></td>
                                <td class="px-4 py-4 font-bold flex justify-evenly items-center">
                                    <a href="/promoteur/demande/<?php echo e($demande->id); ?>">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/demandes/liste-demande-promoteur.blade.php ENDPATH**/ ?>