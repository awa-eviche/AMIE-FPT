...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__("Nouveau programme de formation")); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="<?php echo e(route('niveauetudeetablissement.index')); ?>" class="text-maquette">Accueil</a>
            <span class="mx-2 text-maquette">/</span>
            <a href="<?php echo e(route('niveauetudeetablissement.index')); ?>" class="text-maquette">Programme de formation</a>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('niveauetudeetablissement.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
[$__name, $__params] = $__split('Common.Level', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2176559993-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH C:\wamp64\www\AMIE-FPT\resources\views/niveauetudeetablissement/create.blade.php ENDPATH**/ ?>