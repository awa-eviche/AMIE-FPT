...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        ...
        <p class="text-first-orange">Modifier Catégorie Document</p>
        </p>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('update.category', $categoryFile->id)); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'libelle','value' => ''.e($categoryFile->libelle).'','class' => 'block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 ','type' => 'text','name' => 'libelle','required' => true,'autofocus' => true,'autocomplete' => 'libelle']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'libelle','value' => ''.e($categoryFile->libelle).'','class' => 'block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 ','type' => 'text','name' => 'libelle','required' => true,'autofocus' => true,'autocomplete' => 'libelle']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /var/www/html/amie-fpt/resources/views/categoryDocument/edite.blade.php ENDPATH**/ ?>