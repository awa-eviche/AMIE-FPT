...
<div class="flex mb-5 justify-between">
      ...
      <div class="flex">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('niveauetudeetablissement.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
    ...
    <!--img class="w-full h-auto" src="<?php echo e(asset('assets/images/gray.jpg')); ?>" alt="Sunset in the mountains"-->
             <div class="px-3 py-4">
             <div class="font-bold text-xl mb-2 "><?php echo e($metier->nom ?? '-'); ?></div>
    ...
    <div class="px-3 py-2" >
        ...
        <div class="px-3 py-2"  >
        <a href="<?php echo e(route('niveauetudeetablissement.show', $niveauetudeetablissement->id)); ?>" class="mx-2 px-5 rounded-md py-4 flex text-white text-xs font-semibold text-center shadow-md bg-first-orange items-center justify-center " style="width:100px; position:relative;left:60%;">
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/niveauetudeetablissement/show.blade.php ENDPATH**/ ?>