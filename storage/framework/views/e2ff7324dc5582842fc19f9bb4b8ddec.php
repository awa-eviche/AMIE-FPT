...
<?php endif; ?>
        ...
        <div class="mb-4 text-sm text-gray-600">
            <?php echo e(__('Vous avez oublié votre mot de passe ? Pas de problème. Indiquez-nous votre adresse électronique et nous vous enverrons un lien de réinitialisation du mot de passe qui vous permettra d\'en choisir un nouveau.')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','class' => 'block mt-1 w-full','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'required' => true,'autofocus' => true,'autocomplete' => 'email']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(__('Lien de réinitialisation du mot de passe par courriel')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>