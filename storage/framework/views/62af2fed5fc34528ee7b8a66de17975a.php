...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouvelle commune')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white p-3 bg-white">
        ...
        <p class="text-first-orange">Nouvelle Commune</p>
        </p>
      
    </div>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded">
        <!-- <div class="w-full mx-auto max-w-2xl"> -->
            ...
            <form action="<?php echo e(route('commune.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/communes/create.blade.php ENDPATH**/ ?>