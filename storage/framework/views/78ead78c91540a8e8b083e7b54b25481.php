                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs p-0">
                    <div>
                        ...
                        <div class="flex justify-between items-center">
                            <p class="font-bold py-2 m-4 text-first-orange text-xl">reunions</p>

                            <div class="flex justify-end m-4 bg-first-orange hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded items-center">
                                <a href="<?php echo e(route('reunion.create')); ?>" class="mr-2 text-sm">
                                    Nouvelle reunion
                                </a>
                                <svg height="1em" viewBox="0 0 448 512" style="fill: white">
                            ...
                            <table class="w-full border-t">
                                <thead>
                                    <tr class="text-xs font-bold tracking-wide text-left text-maquette-gris uppercase border-b bg-first-orange">
                                        ...
                                        <th class="px-4 py-4">Date prévue</th>
                                        <th class="px-4 py-4">Date effective</th>
                                        <th class="px-2 py-4">chargé de suivi</th>
                                        <th class="px-2 py-4">Etat</th>
                                        <th class="px-2 py-4 w-[60px]"></th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y ">
                                    <?php $__currentLoopData = $reunions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reunion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-gray-700 ">
                                            <td class="px-4 py-3 border-b"><?php echo e($reunion->id ?? " "); ?></td>
                                            <td class="px-4 py-3 border-b"><?php echo e($reunion->code ?? "- "); ?></td>
                                            <td class="px-4 py-3 border-b"><?php echo e(date('d-m-Y',strtotime($reunion->date_prevue) ?? " ")); ?></td>
                                            
                                            <td class="px-4 py-3 border-b"><?php echo e(date('d-m-Y',strtotime($reunion->date_effective) ?? " ")); ?></td>
                                            <td class="px-4 py-3 border-b"><?php echo e($reunion->chargeSuivi->prenom); ?> <?php echo e($reunion->chargeSuivi->nom ?? ''); ?></td>
                                            ...
                                            <td class="px-2 py-3 border-b w-[60px]">
                                                <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                                    <a href="<?php echo e(route('reunion.show', $reunion->id)); ?>" class="text-maquette-gris">
                                                    ...
                                                    <a href="<?php echo e(route('reunion.edit', $reunion->id)); ?>" class="text-purple-600">
                                                    ...
                                                    <form class="text-center" action="<?php echo e(route('reunion.destroy', $reunion->id)); ?>" method="POST">
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/reunions/index.blade.php ENDPATH**/ ?>