...
<!--[if BLOCK]><![endif]--><?php if($user->hasRole('chef_de_travaux') || $user->hasRole('chef_etablissement')): ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <div class="flex  -mx-3 mb-0  space-x-4 space-x-reverse" style="padding:8px;">
        <!--[if BLOCK]><![endif]--><?php if(optional(Auth()->user()->personnel)->etablissement_id === null): ?>
    ...
    <div class="w-full bg-transparent rounded-lg shadow-xs p-0 flex flex-wrap">
        ...
        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="rounded-lg shadow-md p-4 bg-white2 ">
                ...
                <div class="mt-4">
                    <div class="flex justify-between items-center mt-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!$classe->statut): ?>
...
<?php /**PATH /Applications/MAMP/htdocs/AMIE-FPT/resources/views/livewire/classe/liste-classe.blade.php ENDPATH**/ ?>