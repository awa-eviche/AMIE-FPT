            ...
            <table class="w-full border-t mb-3">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-4">Date de souscription</th>
                        <th class="px-4 py-4">Actions</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $suscribers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suscriber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3 border-b">
                                <?php echo e($suscriber->suscriber_email ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b  font-bold"><span class="text-center px-2 py-1 <?php echo e(($suscriber->suscriber_is_active == 0) ? 'text-red-600 bg-red-100' : 'text-green-600 bg-green-100'); ?>"><?php echo e($suscriber->suscriber_is_active ? 'Actif' : 'Inactif'); ?></span></td>

                            <td class="px-4 py-3 border-b text-maquette-gris"><?php echo e(date('d-m-Y',strtotime($suscriber->created_at)) ?? '-'); ?></td>

                            <td class="px-4 py-3 border-b text-end">
                                <?php if(!$suscriber->suscriber_is_active): ?>
                                    <div class="border shadow-md py-2 text-center">
                                        <a href="<?php echo e(route('enable.suscribers', $suscriber->id)); ?>" class="text-purple-600">
                                            Activer
                                        </a>
                                    </div>
                                <?php else: ?>
                                    <div class="border shadow-md py-2 text-center">
                                        <a href="<?php echo e(route('disable.suscribers', $suscriber->id)); ?>" class="text-red-600">
                                            Désactiver
                                        </a>
                                    </div>
                                <?php endif; ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/front/admin/suscribers.blade.php ENDPATH**/ ?>