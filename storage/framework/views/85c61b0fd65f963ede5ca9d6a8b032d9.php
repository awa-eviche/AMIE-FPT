...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Modifier la question')); ?>
    ...
    <div class="bg-transparent shadow rounded-sm w-full p-4">
        ...
        <div class="w-full mx-auto">
            <form class="bg-white pt-6 pb-8 mb-4" action="<?php echo e(route('faqs.update',$faq->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="p-5">
                                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" value="<?php echo e($faq->question ?? old('question') ?? ''); ?>"
                                               required
                                ...
                                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                                    <div class="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            rows="5"><?php echo e($faq->reponse ?? old('reponse') ?? ''); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                    <div class="mb-4">
                                        ...
                                        <input type="number" value="<?php echo e($faq->priority ?? old('priority') ?? ''); ?>"
                                               class="border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm"
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/faqs/edit.blade.php ENDPATH**/ ?>