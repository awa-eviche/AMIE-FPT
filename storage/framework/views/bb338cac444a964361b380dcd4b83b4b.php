    ...
    <div class="max-w-10xl mx-auto">
        <div class="flex justify-between items-center">
            ...
            <span class="text-first-orange font-bold text-sm">
                <a href="<?php echo e(route('departement.index')); ?>">Liste des départements </a>
                    / <span class="text-orange-600"> departement
                    <?php echo e($departement->nom); ?></span></span>
            <!-- <a href="<?php echo e(route('departement.create')); ?>"
                ...
                </svg><span class="mx-2">Ajouter un département</span>
            </a> -->
        </div>
    </div>
    ...
    <div class="flex md:flex-wrap justify-between  mt-8 mb-10">
        <div class="flex md:w-full  flex-col">
            <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                     ...
                     href="<?php echo e(route('departement.edit', $departement->id)); ?>" style='position:relative;left: 79%;'>
                     Modifier
                 </a>
         </h3>
            <div class="rounded-lg shadow-sm px-8 py-5 bg-white p-4">

                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                        <span>Code du département : </span>
                        <span>
                            <b><?php echo e($departement->code ?? ' - '); ?></b>
                        </span>
                    </div>
                    <div>
                        <span>Nom du département : </span>
                        <span>
                            <b><?php echo e($departement->libelle ?? ' -'); ?></b>
                        </span>
                    </div>
                </div>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/departements/detail-departement.blade.php ENDPATH**/ ?>