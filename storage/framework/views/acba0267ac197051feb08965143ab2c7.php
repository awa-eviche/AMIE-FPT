<div>
    <div class="flex mb-5 justify-between">
        <div class="flex">
            <span href="#"
                class="bg-transparent border-transparent px-6  py-2 flex text-black text-sm text-center  bg-white items-center">
            ...
            <input type="text" wire:model="search" wire:keydown="$refresh" placeholder="Rechercher"
                class="form-input text-sm px-6 py-3 w-max shadow-sm border-white">
        </div>
        <div class="flex">
            ...
            <?php if(auth()->user()->can('edit_apprenant') and !auth()->user()->hasRole(config('constants.roles.superadmin'))): ?>
            <a href="<?php echo e(route('apprenant.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                </svg><span class="mx-2">Ajouter un apprenant</span>
            </a>
            <?php endif; ?>
        </div>
    </div>
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $apprenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apprenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            ...
                            <td class="px-6 py-3 border-b"><?php echo e($apprenant->prenom ?? ' Non renseigné '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($apprenant->nom ?? ' Non renseigné'); ?></td>
							
							<td class="px-6 py-3 border-b"><?php echo e($apprenant->email ?? 'Non renseigné'); ?></td>
							
							<td class="px-6 py-3 border-b"><?php echo e($apprenant->telephone ?? 'Non renseigné'); ?></td>
                            <td class="px-6 py-3 border-b"><?php echo e($apprenant->sexe ?? 'Non renseigné'); ?></td>
                            <td class="px-6 py-3 border-b"><?php echo e($apprenant->commune->libelle ?? 'Non renseigné'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('apprenant.show', $apprenant->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('apprenant.edit', $apprenant->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                    ...
                    'route' => array('apprenant.destroy', $apprenant->id))); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/apprenant/liste-apprenant.blade.php ENDPATH**/ ?>