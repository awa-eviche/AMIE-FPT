...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouvelle Inscription')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="<?php echo e(route('inscription.index')); ?>"  class="text-maquette">Accueil</a>
              <span class="mx-2 text-maquette">/</span>
            <a href="<?php echo e(route('inscription.index')); ?>"  class="text-maquette">Gestion des apprenants</a>
              <span class="mx-2 text-maquette">/</span>
      

        <p class="text-first-orange">Nouvelle Inscription</p>
        </p>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('inscription.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="border border-gray-200 p-4">
                    <div class="flex flex-wrap w-full justify-evenly">
                        <div class="flex-grow mb-4 mr-2">
                            ...
                            <select class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" id="classe_id" name="classe_id">
                        ...
                        <div class="flex-grow mb-4 mr-2">
                            ...
                            <select class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" id="apprenant_id" name="apprenant_id">
                                ...
                                <option value="<?php echo e($apprenant->id); ?>"><?php echo e($apprenant->nom); ?> <?php echo e($apprenant->prenom); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php endif; ?><?php /**PATH /var/www/html/amie-fpt/resources/views/inscription/create.blade.php ENDPATH**/ ?>