                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <div class="text-sm text-gray-600">
                                <?php echo e($session->agent->platform() ? $session->agent->platform() : __('Inconnu')); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : __('Inconnu')); ?>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    <?php if($session->is_current_device): ?>
                                        <span class="text-green-500 font-semibold"><?php echo e(__('Cet appareil')); ?></span>
                                    <?php else: ?>
                                        <?php echo e(__('Dernière activité')); ?> <?php echo e($session->last_active); ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('Déconnexion des autres sessions du navigateur')); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('Veuillez saisir votre mot de passe pour confirmer que vous souhaitez vous déconnecter de vos autres sessions de navigation sur tous vos appareils.')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>