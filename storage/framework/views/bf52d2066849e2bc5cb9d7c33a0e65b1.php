...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('critere.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter un seuil de réussite</span>
    ...
    <div class="flex mb-5 gap-4">
        ...
        <div>
            ...
            <select wire:model="selectedMetier" id="metier" wire:change="$refresh"
        ...
        <div>
            ...
            <select wire:model="selectedNiveau" id="niveau" wire:change="$refresh"
                    class="border border-gray-300 p-2 rounded text-sm" <?php echo e(empty($niveaux) ? 'disabled' : ''); ?>>
        ...
        <div>
            ...
            <select wire:model="selectedCompetence" id="competence" wire:change="$refresh"
                    class="border border-gray-300 p-2 rounded text-sm" <?php echo e(empty($competences) ? 'disabled' : ''); ?>>
        ...
        <div>
            ...
            <select wire:model="selectedElement" id="element"
                    class="border border-gray-300 p-2 rounded text-sm" <?php echo e(empty($elements) ? 'disabled' : ''); ?>>
    ...
    <div class="w-full rounded-lg shadow-xs p-0">
        <div class="text-sm w-full p-0">
            ...
            <thead>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $criteres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $critere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/param/critere.blade.php ENDPATH**/ ?>