...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(( route('elementcompetence.multiple.create'))); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
    ...
    <form action="<?php echo e(route('matiere.index')); ?>" method="GET">
...
<!--[if BLOCK]><![endif]--><?php if(!empty($niveaux) && $niveaux->count()): ?>
<div style="display: inline-block; margin-right: 10px;">
...
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> éléments de compétences trouvés</span></div>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <thead>
                ...
                <tbody class="bg-white divide-y ">
                    <?php
                        $num = 1;
                    ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $elementcompetences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elementcompetence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                      
                                    <td class="px-6 py-3 border-b"><?php echo e($num); ?></td> 
                         
                            <td class="px-6 py-3 border-b"><?php echo e($elementcompetence->code ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($elementcompetence->nom ?? '-'); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($elementcompetence->metier->nom ?? '-'); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($elementcompetence->competence->nom ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('elementcompetence.show', $elementcompetence->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('elementcompetence.edit', $elementcompetence->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
...
<?php /**PATH C:\wamp64\www\AMIE-FPT\resources\views/livewire/parametrage/elementcompetence/liste-elementcompetence.blade.php ENDPATH**/ ?>