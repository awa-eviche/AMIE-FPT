...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Visualisation du secteur')); ?>
        ...
        <div class="w-full mx-auto max-w-6xl">
            <div class="rounded-lg shadow-sm px-8 py-5 bg-white">
                ...
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange py-2">
                        ...
                        href="<?php echo e(route('secteur.edit', $secteur->id)); ?>">
                        Modifier
                    </a>
                </h3>
                <div class="border border-gray-200">
                    ...
                    <div class="flex justify-between text-black items-center mt-3 text-sm">
                        <div>
                            ...
                            <span>
                                <b><?php echo e($secteur->code ?? ' - '); ?></b>
                            </span>
                        </div>
                        <div>
                            <span>Libellé du secteur : </span>
                            <span>
                                <b><?php echo e($secteur->libelle ?? ' -'); ?></b>
                            </span>
                        </div>
                    </div>
                   <br>
                       <div>
                        ...
                        <span>
                            <b><?php echo e($secteur->description ?? ' -'); ?></b>
                        </span>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/secteurs/show.blade.php ENDPATH**/ ?>