<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('create.slider')); ?>" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    </svg><span class="mx-2">Nouveau slider</span>
            </a>
        </div>
    </div>
            ...
            <table class="w-full border-t mb-3">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-4">Slider image</th>
                        <th class="px-4 py-4">Slider titre</th>
                        <th class="px-4 py-4">Statut</th>
                        <th class="px-4 py-4">Date de création</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3 border-b">
                                <a target="_blank" href="<?php echo e(asset('storage/front/sliders/'. $slider->slider_img)); ?>"><img class="thumbnail-slider" src="<?php echo e(asset('storage/front/sliders/'. $slider->slider_img)); ?>" alt="avatar" /></a>
                            </td>
                            <td class="px-4 py-3 border-b text-maquette-gris">
                                <?php echo e($slider->slider_titre ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b  font-bold"><span class="text-center px-2 py-1 <?php echo e(($slider->slider_is_active == 0) ? 'text-red-600 bg-red-100' : 'text-green-600	bg-green-100'); ?>"><?php echo e($slider->slider_is_active ? 'Actif' : 'Inactif'); ?></span></td>

                            <td class="px-4 py-3 border-b text-maquette-gris"><?php echo e(date('d-m-Y',strtotime($slider->created_at)) ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('edit.slider', $slider->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="<?php echo e(route('destroy.slider', $slider->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/front/sliders.blade.php ENDPATH**/ ?>