<?php
    ...
    $btnTous = empty($role) ? $activeBtn : $normalBtn;
?>
<div>
        ...
        <div class="relative">
            <div class="inset-y-4 pt-2 left-0">
                <a href="<?php echo e(route('users.index')); ?>">
                    <button type="button" class="<?php echo e($btnTous); ?>">
                        Tous (<?php echo e($roleStats['total']); ?>)
                    </button>
                </a>
                <?php $__currentLoopData = $roleStats['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('users.filter.role', strtolower($key))); ?>">
                        <button type="button" class="<?php echo e(isset($role) && $role === $key ? $activeBtn : $normalBtn); ?>">
                            <?php echo e($value['nom']); ?> (<?php echo e($value['nb']); ?>)
                        </button>
                    </a>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/projet/partials/_header.blade.php ENDPATH**/ ?>