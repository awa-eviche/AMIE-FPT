<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('entreprise.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <table class="w-full border-t mb-3">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-4">Nom E</th>
                        <th class="px-4 py-4">Email E</th>
                        <th class="px-4 py-4">Ninea</th>
                ...
                <tbody class="bg-white divide-y ">
                    <?php $__empty_1 = true; $__currentLoopData = $entreprises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entreprise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            <td class="px-4 py-3 border-b"><?php echo e($entreprise->nom_entreprise ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b text-maquette-gris">
                                <?php echo e($entreprise->email_entreprise ?? ' - '); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($entreprise->ninea ?? '-'); ?></td>
                            <td class="px-4 py-3 border-b text-maquette-gris"><?php echo e($entreprise->effectif ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('entreprise.show', $entreprise->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('entreprise.edit', $entreprise->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="<?php echo e(route('entreprise.destroy', $entreprise->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/entreprises/liste-entreprise.blade.php ENDPATH**/ ?>