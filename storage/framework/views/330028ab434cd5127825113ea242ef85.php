...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            ...
            <span class="mx-2 text-maquette">/</span>
            <span class="text-first-orange">Nouveau Métier</span>
        </p>
    </div>

    <div class="rounded-sm w-full">
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('metier.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-4">
                        <label for="filiere_id" class="block text-sm font-bold text-gray-700">Sélectionner une filière :</label>
                    ...
                    <div class="form-group mb-4">
                        <label for="modalite" class="block text-sm font-bold text-gray-700">Modalité :</label>
                    ...
                    <div class="form-group mb-4">
                        <label for="statut_programme" class="block text-sm font-bold text-gray-700">Statut du programme :</label>
                    ...
                    <div class="mb-4 mx-auto w-full">
                        ...
                        <textarea id="description" name="description" rows="4" required
                                  ...
                                  class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline enlever_shadow"><?php echo e(old('description')); ?></textarea>
                    </div>

                    
                    <div class="flex items-center justify-end">
                        <button type="submit"
                                class="items-center flex bg-first-orange hover:bg-cyan-700 text-white font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline">
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/metier/create.blade.php ENDPATH**/ ?>