<div class="max-w-10xl mx-auto mt-5">
    <div class="w-full flex justify-between">
        ...
        <?php if($typeUser === "DFPT" || auth()->user()->hasRole(config('constants.roles.ia'))): ?>
            <div class="">
    ...
    <?php endif; ?>
        ...
        <?php if($editDocument): ?>
            <div class="mx-auto max-w-5xl shadow-xl rounded">
                <form action="<?php echo e(route('update.document', $idDocument)); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data">
                   <?php echo method_field('put'); ?>
                    <?php echo csrf_field(); ?>
                    <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                        Modifier le nom document :<?php echo e($idDocument); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'libelle','class' => ' w-96 focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 ','type' => 'text','name' => 'libelle','value' => ''.e($libelleDocument).'','required' => true,'autofocus' => true,'autocomplete' => 'libelle']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <div class="py-10">
        <div class="flex justify-start bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
            <div class="w-1/4 h-full  text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                <?php $__empty_1 = true; $__currentLoopData = $categoryFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryFile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex  justify-start ">
                        <a  class="element_sidebar selectCategory"  wire:click="getFileCategory(<?php echo e($categoryFile->fichiers); ?>, <?php echo e(collect( $categoryFile->access)); ?>,'<?php echo e($categoryFile->libelle); ?>')">
                    ...
                    <div class="flex items-start ">
                        ...
                        <div id="<?php echo e($categoryFile->id); ?>" class="z-10 my-48 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-40 dark:bg-gray-700 dark:divide-gray-600">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                                    <?php if($typeUser === "DFPT" || in_array("Ajouter", $categoryFile->access[$typeUser])): ?>
                                    <li>
                                ...
                                <?php endif; ?>
                                <?php if($typeUser == "DFPT" || $accessUpdate ==="Modifier"  ): ?>
                                    <li>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="w-full flex flex-wrap justify-start border-2 rounded   mx-3">
                ...
                <?php if($fichiers): ?>
                    <?php $__empty_1 = true; $__currentLoopData = $fichiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fichier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div  class="min-w-35 h-48 m-3 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" type="button">
                                ...
                                <div class=" flex justify-evenly">
                                    ...
                                    <a href="#" wire:click="download('<?php echo e($fichier["document"]); ?>', '<?php echo e($fichier["libelle"]); ?>')">
                                        ...
                                        <?php if($typeUser === "DFPT" || $fichier['user_id'] == auth()->user()->id): ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/CategoryFile/list-categoryfa.blade.php ENDPATH**/ ?>