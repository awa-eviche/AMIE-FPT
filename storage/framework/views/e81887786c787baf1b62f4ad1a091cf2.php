...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white p-3 bg-white">
        <p>
            ...
            <span class="mx-2 text-maquette">/</span>
        <p> <a href="<?php echo e(route('commune.index')); ?>">IA </a>

            <span class="mx-2 text-maquette">/</span>
        </p>

        <p class="text-first-orange">Nouvelle IA</p>
        </p>
             
            
    </div>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded">
        ...
        <form action="<?php echo e(route('ia.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
            <?php echo csrf_field(); ?>
            <div class="border border-gray-200">
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                    Formulaire d'ajout d'une nouvelle Ia
                </h3>
...
<?php endif; ?>
                    <div class="checkbox-columns" style="column-count: 4; column-gap: 20px;">
                        ...
                        <div class="form-check" style="margin-bottom: 10px;">
                            <input class="form-check-input" type="checkbox" id="departement_<?php echo e($departement->id); ?>" name="departements[]" value="<?php echo e($departement->id); ?>">
...
<?php endif; ?><?php /**PATH /var/www/html/amie-fpt/resources/views/ia/create.blade.php ENDPATH**/ ?>