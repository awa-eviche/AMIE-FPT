<div class="bg-white shadow rounded-sm w-full p-4">
    ...
    <div class="w-full mx-auto">
        <form class="bg-white shadow-md rounded pt-6 pb-8 mb-4" action="<?php echo e(route('etablissement.update', $etablissement->id)); ?>" method="POST">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/communes/edit-commune.blade.php ENDPATH**/ ?>