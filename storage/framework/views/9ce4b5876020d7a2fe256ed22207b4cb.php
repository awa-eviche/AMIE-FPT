    ...
    <div class="w-full rounded-lg shadow-xs p-0">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-4">
            <div class="font-bold text-lg text-red-600">
                <?php if($apprenant && $apprenant->apprenant): ?>
                    Évaluation de :
            ...
            <?php if(auth()->user()->hasRole('formateur')): ?>
                <button type="button"
                        onclick="gatherInfos()"
        ...
        <table class="w-full border mb-6">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $competencesGenerales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <?php $__currentLoopData = $comp->elementCompetences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $el->ressource()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rIndex => $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
        ...
        <table class="w-full border-t mb-3">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $competences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cptCompetence => $competence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                <?php $rowspanCount = 0; ?>

                <?php $__currentLoopData = $competence->elementCompetences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elementCompetence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $elementCompetence->criteres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cpt => $critere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/apprenant/competence/evaluation.blade.php ENDPATH**/ ?>