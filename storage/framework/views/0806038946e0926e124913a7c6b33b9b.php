...
<body class="font-sans antialiased">
    ...
    <div class="mx-auto max-w-screen-lg pt-10 mb-[5%]">
        <div class="bg-white py-2 px-3 pb-10">
            <div class="flex justify-between items-center">
                ...
                <img class="px-4 w2/5" src="<?php echo e(asset('assets/images/back_secteurs.png')); ?>" alt="" srcset="">
            </div>
        </div>
    ...
    <?php echo $__env->make('partials.footerv2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/secteurs_porteurs.blade.php ENDPATH**/ ?>