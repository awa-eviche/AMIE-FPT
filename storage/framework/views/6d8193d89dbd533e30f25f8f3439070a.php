...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        ...
        <p>
            <a href="<?php echo e(route("workflow.show", $workflow->id)); ?>"  class="text-first-orange">WF : <?php echo e($workflow->code); ?></a>
        </p>
        <span class="mx-2 text-maquette-gris">/</span>

        <p class="text-first-orange">Nouvel état</p>
    </div>

    <div class="bg-white shadow rounded-sm w-full">
        <div class="w-full mx-auto max-w-2xl">
            <form action="<?php echo e(route('etat_workflow.store')); ?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
              <?php echo csrf_field(); ?>

              <input type="hidden" name="workflow_id" value="<?php echo e($workflow->id); ?>" />
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'position','class' => 'block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 ','type' => 'number','name' => 'position','value' => old('position'),'required' => true,'autofocus' => true,'autocomplete' => 'position']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'position','class' => 'block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 ','type' => 'number','name' => 'position','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('position')),'required' => true,'autofocus' => true,'autocomplete' => 'position']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <select class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="status" name="status" required>
                            <option value="<?php echo e(App\Enums\StatusDemandeEnum::BROUILLON); ?>">Brouillon</option>
                            <option value="<?php echo e(App\Enums\StatusDemandeEnum::COURS); ?>">En cours</option>
                            <option value="<?php echo e(App\Enums\StatusDemandeEnum::REJETE); ?>">Rejeté</option>
                            <option value="<?php echo e(App\Enums\StatusDemandeEnum::ATTENTE); ?>">Attente de complément</option>
                            <option value="<?php echo e(App\Enums\StatusDemandeEnum::AVIS_FAVORABLE); ?>">Favorable</option>
                            <option value="<?php echo e(App\Enums\StatusDemandeEnum::AVIS_DEFAVORABLE); ?>">Non favorable</option>
                            <option value="<?php echo e(App\Enums\StatusDemandeEnum::VALIDE); ?>">Validé</option>
                        </select>
                    </div>
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    ...
                    <div class="flex-grow mb-4 mr-2 self-center">
                        <label class="block text-gray-700 font-bold mb-2">Est final :</label>
                        <div class="flex items-center">
                            <label class="mr-4">
                                <input type="radio" name="est_fin" value="1" class="form-radio text-blue-600" <?php echo e(old('est_fin') == '1' ? 'checked' : ''); ?>>
                                <span class="ml-2">OUI</span>
                            </label>
                            <label>
                                <input type="radio" name="est_fin" value="0" class="form-radio text-red-600" <?php echo e(old('est_fin') == '0' ? 'checked' : ''); ?>>
                                <span class="ml-2">NON</span>
                            </label>
                        </div>
                    </div>

                    <div class="flex-grow mb-4 mrl-2 self-center">
                        <label class="block text-gray-700 font-bold mb-2">Est rejetable :</label>
                        <div class="flex items-center">
                            <label class="mr-4">
                                <input type="radio" name="est_rejetable" value="1" class="form-radio text-blue-600" <?php echo e(old('est_rejetable') == '1' ? 'checked' : ''); ?>>
                                <span class="ml-2">OUI</span>
                            </label>
                            <label>
                                <input type="radio" name="est_rejetable" value="0" class="form-radio text-red-600" <?php echo e(old('est_rejetable') == '0' ? 'checked' : ''); ?>>
                                <span class="ml-2">NON</span>
                            </label>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/etats/create.blade.php ENDPATH**/ ?>