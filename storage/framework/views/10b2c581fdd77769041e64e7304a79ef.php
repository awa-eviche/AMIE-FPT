...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Détails du diplôme')); ?>
        ...
        <div class="w-full mx-auto max-w-6xl">
            ...
            <div class="border border-gray-200">
             <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                        ...
                        href="<?php echo e(route('diplome.edit', $diplome->id)); ?>" style='position:relative;left: 81%;'>
                        Modifier
                    </a>
                            </h3>
                </div>
                <div class="flex justify-between text-black items-center mt-3 text-sm">
                    <div>
                        ...
                        <span>
                            <b><?php echo e($diplome->code ?? ' - '); ?></b>
                        </span>
                    </div>
                    <div>
                        <span>Libellé du diplôme : </span>
                        <span>
                            <b><?php echo e($diplome->nom ?? ' -'); ?></b>
                        </span>
                    </div>
                </div>
                <br>
                       <div>
                        ...
                        <span>
                            <b><?php echo e($diplome->description ?? ' -'); ?></b>
                        </span>
                    </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/diplome/show.blade.php ENDPATH**/ ?>