...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('niveauetude.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
    ...
    <form action="<?php echo e(route('niveauetude.index')); ?>" method="GET">
...
<div style="display: inline-block;margin-right: 20px; ">
    ...
    <div style="display: inline-block;">
        ...
        <select  class="block  focus:border-first-orange enlever_shadow rounded  shadow-first-orange text-sm border-2" name="niveau_id"wire:model="selectedNiveauDiplome" id="selectedNiveauDiplome" name="niveauetude_id" wire:change="$refresh">
             ...
             <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $diplome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded"><?php echo e($count); ?> Niveaux d'études trouvés</span></div>
            ...
            <thead>
                ...
                <tbody class="bg-white divide-y ">
                    <?php
                        $num = 1;
                    ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $niveauetudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-700 ">
                            
                       
                                    <td class="px-6 py-3 border-b"><?php echo e($num); ?></td> 
                            <td class="px-6 py-3 border-b"><?php echo e($niv->code ?? ' - '); ?></td>
                
                            <td class="px-6 py-3 border-b"><?php echo e($niv->nom ?? '-'); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($niv->metier->nom ?? '-'); ?></td>
                            <td class="px-4 py-3 border-b"><?php echo e($niv->diplome->nom ?? '-'); ?></td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('niveauetude.show', $niv->id)); ?>"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="<?php echo e(route('niveauetude.edit', $niv->id)); ?>" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
...
<?php /**PATH /var/www/html/pgi/resources/views/livewire/parametrage/niveauetude/liste-niveauetude.blade.php ENDPATH**/ ?>