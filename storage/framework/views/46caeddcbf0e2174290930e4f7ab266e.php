<div>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!--[if BLOCK]><![endif]--><?php if($etablissements->total() > $etablissements->perPage()): ?>
    <div class="mt-3">
...
<?php /**PATH /Applications/MAMP/htdocs/AMIE-FPT/resources/views/livewire/dfpt/getalletablissement.blade.php ENDPATH**/ ?>