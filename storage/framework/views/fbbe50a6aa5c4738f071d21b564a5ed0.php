...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Liste des Types de Notification')); ?>
    ...
    <div class="container p-2 rounded">
        <div class="flex justify-between items-center mb-3">
            <h2 class="font-bold text-first-orange">Liste des Types de notification</h2>
            <div class="flex justify-end">
                <a href="<?php echo e(route('type_notification.create')); ?>" class="flex bg-first-orange hover:bg-cyan-700 text-white font-bold py-1 text-sm px-4 rounded">
                    <span class="mr-2">Nouveau type de notification</span>
                    <svg style="fill: white" height="20" width= "20" viewBox="0 0 448 512">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs p-0">
            <div class="w-full overflow-x-scroll p-0">
                <table class="w-full border-t">
                    <thead>
                        <tr class="bg-first-orange text-xs font-black tracking-wide text-left text-maquette-gris uppercase border-b">
                    ...
                    <tbody class="bg-white divide-y ">
                        <?php $__currentLoopData = $typeNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeNotification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-gray-700">
                                <td class="px-4 py-3 border-b"><?php echo e($typeNotification->action); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($typeNotification->message); ?></td>
                                <td class="px-4 py-3 border-b">
                                    <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                        <a href="<?php echo e(route('type_notification.show', $typeNotification->id)); ?>" class="text-maquette-gris">
                                        ...
                                        <a href="<?php echo e(route('type_notification.edit', $typeNotification->id)); ?>" class="text-purple-600">
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/type_notification/index.blade.php ENDPATH**/ ?>