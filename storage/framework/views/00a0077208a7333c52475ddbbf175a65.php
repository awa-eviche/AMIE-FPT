            ...
            <table class="min-w-full border border-gray-300 text-sm rounded-lg">
                <thead class="border-maquette-gris">
                    <tr class="flex">
                        ...
                        <td class="py-2 px-4 border-b w-2/3 border-l "><?php echo e($donnees["email"]); ?></td>
                    </tr>
                    <tr class="flex">
                        <th class="w-1/3 flex items-center py-2 px-2 border-b">Nom </th>
                        <td class="py-2 px-4 border-b w-2/3 border-l "><?php echo e($donnees["nom"]); ?></td>
                    </tr>
                </thead>
                <tbody>
                    <tr class="flex">
                        <th class="w-1/3 flex items-center py-2 px-2 border-b">Prénom</th>
                        <td class="py-2 px-4 border-b w-2/3 border-l "><?php echo e($donnees["prenom"]); ?></td>
                    </tr>
                    <tr class="flex">
                        <th class="w-1/3 flex items-center py-2 px-2 border-b">Date de naissance</th>
                        <td class="py-2 px-4 border-b w-2/3 border-l"><?php echo e($donnees["date_naissance"]); ?></td>
                    </tr>
                    <tr class="flex">
                        <th class="w-1/3 flex items-center py-2 px-2 border-b">Lieu de naissance</th>
                        <td class="py-2 px-4 border-b w-2/3 border-l"><?php echo e($donnees["lieu_naissance"]); ?></td>
                    </tr>
                    <tr class="flex">
                        <th class="w-1/3 flex items-center py-2 px-2 border-b">Adresse</th>
                        <td class="py-2 px-4 border-b w-2/3 border-l"><?php echo e($donnees["adresse"]); ?></td>
                    </tr>
                    <tr class="flex">
                        <th class="w-1/3 flex items-center py-2 px-2 border-b">N° Téléphone </th>
                        <td class="py-2 px-4 border-b w-2/3 border-l"><?php echo e($donnees["telephone"]); ?></td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="max-w-7xl sm:px-2 lg:px-2 mx-3">
            <table class="min-w-full border border-gray-300 text-sm rounded-lg">
                <tr class="flex">
                    ...
                    <td class="py-2 px-4 border-b w-2/3 border-l "><?php echo e($donnees["nom_entreprise"]); ?></td>
                </tr>
                ...
                <tr class="flex">
                    ...
                    <td class="py-2 px-4 border-b w-2/3 border-l "><?php echo e($donnees["ninea"]); ?></td>
                </tr>
                <tr class="flex">
                    <th class="w-1/3 flex items-center py-2 px-2 border-b">Effectif</th>
                    <td class="py-2 px-4 border-b w-2/3 border-l"><?php echo e($donnees["effectif"]); ?></td>
                </tr>
                <tr class="flex">
                    <th class="w-1/3 flex items-center flex-start py-2 px-2 border-b">Date de création</th>
                    <td class="py-2 px-4 border-b w-2/3 border-l"><?php echo e($donnees["date_creation"]); ?></td>
                </tr>
            </table>
        </div>
    </div>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/demandes/recap-demande.blade.php ENDPATH**/ ?>