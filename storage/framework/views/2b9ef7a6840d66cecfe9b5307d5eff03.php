...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouvelle element de competence')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            ...
            <a href="<?php echo e(route('elementcompetence.index')); ?>"  class="text-maquette">Référentiel</a>
              <span class="mx-2 text-maquette">/</span>
        <p> <a href="<?php echo e(route('elementcompetence.index')); ?>" > Element de Compétence </a>
            
            <span class="mx-2 text-maquette">/</span>
        </p>

        <p class="text-first-orange">Nouvelle Element de Compétence</p>
        </p>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="<?php echo e(route('elementcompetence.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                    Création d'un element de  competence
                </h3>
...
[$__name, $__params] = $__split('parametrage.ElementCompetence.CreateElementCompetence');

$__html = app('livewire')->mount($__name, $__params, 'lw-1748176751-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/elementcompetence/create.blade.php ENDPATH**/ ?>