...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Nouveau workflow')); ?>
    ...
    <div class="flex mb-4 text-sm font-bold">
        ...
        <p class="text-first-orange">Nouveau workflows</p>
    </div>

    <div class="bg-white shadow rounded-sm w-full">
        <div class="w-full mx-auto max-w-2xl">
            <form action="<?php echo e(route('workflow.store')); ?>" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                <?php echo csrf_field(); ?>
...
<?php unset($__componentOriginald8ba2b4c22a13c55321e34443c386276); ?>
<?php endif; ?>
                        <select class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="type_demande_id" name="type_demande_id" required>
...
<?php endif; ?>
<?php /**PATH /var/www/html/amie-fpt/resources/views/parametrage/workflows/create.blade.php ENDPATH**/ ?>