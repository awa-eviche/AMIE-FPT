<div>
    ...
    <?php $__currentLoopData = $etablissements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etablissement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr class="text-gray-700">
            ...
            <td class="p-2 border-b text-gray-500">
                <?php echo e($etablissement->reference ?? '-'); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($etablissements->total() > $etablissements->perPage()): ?>
    <div class="mt-3">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/dfpt/getalletablissement.blade.php ENDPATH**/ ?>