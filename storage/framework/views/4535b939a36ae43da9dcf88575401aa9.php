<div>
    ...
    <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4"> 
        ...
        <?php $__currentLoopData = $indicateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indicateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a wire:click="getRealisations('<?php echo e($indicateur->id); ?>','<?php echo e($indicateur->typeIndicateur->libelle); ?>')" href="#" class="element_sidebar_acitf flex items-center justify-between p-2 rounded-md dark:bg-darker">
            <div>
                ...
                <?php echo e($indicateur->typeIndicateur->libelle); ?>
                                                ...
                                                <tbody class="bg-white divide-y ">
                                                    ...
                                                    <tr class="text-gray-700 ">
                                                        <td class="px-6 py-3 border-b">
                                                            <?php echo e($realisation->indicateur->typeIndicateur->libelle ?? ' - '); ?>

                                                        </td>
                                                        <td class="px-6 py-3 border-b">
                                                            <?php echo e($realisation->etablissement->sigle??' - '); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/d-f-p-t/get-all-indiacteurs.blade.php ENDPATH**/ ?>