<div>
    ...
    <div class="mb-4 mx-auto w-full">
        ...
        <select wire:model="niveau" id="niveau" wire:change="$refresh" class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700">
            ...
            <?php $__currentLoopData = $niveauEtudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveauEtude): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/parametrage/elementcompetence/edit-elementcompetence.blade.php ENDPATH**/ ?>