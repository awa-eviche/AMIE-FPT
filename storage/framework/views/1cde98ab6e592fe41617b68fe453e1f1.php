        ...
        <div>
            <li class="flex items-center justify-between mb-2 bg-gray-100 w-[350px] m-3 p-3">
                <div class="flex items-center">
                    ...
                    <span class="ml-3"><?php echo e($realPv["nom"]); ?></span>
                </div>
                <div class="flex items-center w-[60px] justify-between">
                    <a href="<?php echo e(asset('/storage/' . $realPv->lien_ressource)); ?>" target="_blank">
                    ...
                    <a href="<?php echo e(asset('/storage/' . $realPv->lien_ressource)); ?>" download>
            ...
            <?php if($reunion->membres->contains(Auth::user()) && $reunion->etat == App\Enums\ReunionEtatEnum::ASIGNE): ?>
                <div>
                    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('reunions.valider-pv', ['reunion' => $reunion]);

$__html = app('livewire')->mount($__name, $__params, 'lw-1164743145-0', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <?php else: ?>
        <div class="flex justify-end my-2">
            <?php if($uploadPermi && !$isModifying): ?>
                <button <?php echo e($disabled ? "disabled" : ''); ?> wire:click="toggleIsModifying" class="bg-first-orange text-white px-3 py-2 text-sm font-bold rounded">Uploader PV</button>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end mt-3">
                    <button <?php echo e($disabled ? "disabled" : ''); ?> wire:click="toggleIsModifying" class="mr-3 bg-red-800 hover:bg-red-900 hover:shadow-xl text-white px-3 py-2 text-sm text-bold rounded">
                        Annuler</button>
                    <button <?php echo e($disabled ? "disabled" : ''); ?> wire:click="uploadPV" class="flex items-center bg-first-orange hover:shadow-xl text-white px-3 py-2 text-sm text-bold rounded">
...
<?php /**PATH /var/www/html/amie-fpt/resources/views/livewire/reunions/upload-pv.blade.php ENDPATH**/ ?>