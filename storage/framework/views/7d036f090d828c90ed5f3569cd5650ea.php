 		...
 		<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <main class="min-h-screen">
                    ...
                    <div class="flex items-center justify-start px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
                        <h1 class="text-1xl font-semibold"><?php echo e($header?? null); ?></h1>
                    </div>
...
<?php /**PATH C:\env_dev\projets\AmieFPT\AMIE-FPT\resources\views/layouts/app.blade.php ENDPATH**/ ?>