<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="<?php echo e(route('etablissement.create')); ?>" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="grid md:grid-cols-1 md:gap-6 pt-2">
            <div class="mb-4">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['commune'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    <div class="w-full bg-transparent rounded-lg shadow-xs p-0 flex flex-wrap">
        ...
        <div class="sm:w-1/3 w-full p-4">
            <div class="rounded-lg shadow-md p-4 bg-white3">
                <h1 class="font-bold text-lg"><i class="fa-solid fa-building text-orange-clair"></i> <?php echo e($etablissement->nom); ?></h1>
                <hr class="my-2" />
                <div class="flex mb-4 items-center">
                    <img class="rounded-lg w-1/3 sm:w-1/6" src="<?php echo e(asset('storage/etablissements/'. $etablissement->logo)); ?>" alt="Logo" />
                    <div class="px-4 flex-1">
                        <h3 class="text-sm py-1"><i class="text-orange-clair fa fa-location"></i>&nbsp;Région : <span class="font-bold"><?php echo e($etablissement->commune->departement->region->libelle ?? ' - '); ?></span></h3>
                        <h3 class="text-sm py-1"><i class="text-orange-clair fa fa-list"></i>&nbsp;Type : <span class="font-bold"><?php echo e($etablissement->statut ?? ' - '); ?></span></h3>
                        <h3 class="text-sm py-1"><i class="text-orange-clair fa fa-list"></i>&nbsp;Contact : <span class="font-bold"><?php echo e($etablissement->telephone ?? ' - '); ?></span></h3>
                        
                    </div>
                    <div class="px-4 flex items-end">
                        <div class="flex items-center <?php echo e($etablissement->is_active ? 'bg-orange-100' : 'bg-red-100'); ?> px-4 py-1 rounded-lg">
                ...
                <div class="mt-4">
                    <div class="flex justify-between items-center mt-3">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_etablissement')): ?>
                        <a href="<?php echo e(route('etablissement.edit',$etablissement->id)); ?>" class="flex items-center px-1 rounded-md py-1 border flex text-orange-600 text-sm text-center bg-white border-orange-600 hover:bg-orange-600 hover:text-white">
                            <i class="fa fa-edit"></i>
                            <span class="mx-2">Modifier</span>
                        </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('etablissement.show',$etablissement->id)); ?>" class="flex items-center px-1 rounded-md py-1 border flex text-green-600 text-sm text-center bg-white border-green-600 hover:bg-green-600 hover:text-white">
                            <i class="fa fa-eye"></i>
...
<?php /**PATH C:\env_dev\projets\AmieFPT\AMIE-FPT\resources\views/livewire/etablissements/liste-etablissement.blade.php ENDPATH**/ ?>