<x-app-layout>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            ...
            <a href="{{route('competence.index')}}"  class="text-maquette">Référentiel</a>
              <span class="mx-2 text-maquette">/</span>
        <p> <a href="{{route('competence.index')}}" >Matiére  </a>
            
            <span class="mx-2 text-maquette">/</span>
        </p>

        <p class="text-first-orange">Nouvelle competence</p>
        </p>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="{{ route('competence.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                @csrf
