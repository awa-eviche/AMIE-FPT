...
class DemandeController extends Controller
{
    ...
    public function getRequestByIdEtab($etablissementId)
    {
    ...
    public function genererRecepisser(Demande $demande){
        ...
        if($non_conforme){
            $nomFichier = 'Recepisse_de_Rejet ' . uniqid() . '.pdf';
            $pdf = Pdf::loadView('pdf.recepisse-rejet', compact('demande'));
            $document->description = "Le recepisse de rejet d'une demande";

        }else{
            $nomFichier = 'Recepisse_de_Depot ' . uniqid() . '.pdf';
            $pdf = Pdf::loadView('pdf.recepisse-depot', compact('demande'));
            $document->description = "Le recepisse de dépot d'une demande";
