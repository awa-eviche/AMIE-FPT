...
class InspecteurController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('inspecteur.index')
                ->with('message', 'L\'inspecteur a été créé avec succès.');
        } catch (\Exception $e) {
            Log::info($e);
            DB::rollback();
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('inspecteur.index')
            ->with('success', 'L\'inspecteur a été mise à jour avec succès.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('inspecteur.index')
            ->with('success', 'L\'inspecteur a été supprimée avec succès.');
    }
}
