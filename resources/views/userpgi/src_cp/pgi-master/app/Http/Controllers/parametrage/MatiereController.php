...
class MatiereController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->logUserRepository->store(['action' => UserAction::AddMatiere, 'model' => Model::Matiere, 'new_object' => json_encode($matiere)]);


        return redirect()->route('matiere.index')
                        
                         ->with('success', 'Matière créé avec succès.');
    }
    ...
    public function update(Request $request, Matiere $matiere)
    {
        ...
        return redirect()->route('matiere.index')
                         ->with('success', 'Matiere mis à jour avec succès.');
    }
    ...
    public function destroy(Matiere $matiere)
    {
        ...
        return redirect()->route('matiere.index')
                         ->with('success', 'Matiere supprimé avec succès.');
    }
}