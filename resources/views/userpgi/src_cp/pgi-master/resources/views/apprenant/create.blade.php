                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    <x-label for="nationalite">
                                        Nationalite <span class="text-red-500">*</span>
                                    </x-label>
                                    <select id="nationalite" name="nationalite" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" required autofocus>
                                        ...
                                        <option value="{{ $nationalite->nationality }}">{{ $nationalite->nationality}}</option>
                                        @endforeach
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="nomTuteur" x-model="nomTuteur" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="nomTuteur" :value="old('nomTuteur')" required autofocus autocomplete="nomTuteur" />
                                    @error('nomTuteur')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="prenomTuteur" x-model="prenomTuteur" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="prenomTuteur" :value="old('prenomTuteur')" required autofocus autocomplete="prenomTuteur" />
                                    @error('prenomTuteur')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="numTelTuteur" x-model="numTelTuteur" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="numTelTuteur" :value="old('numTelTuteur')" required autofocus autocomplete="numTelTuteur" />
                                    @error('numTelTuteur')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="matricule" x-model="matricule" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="matricule" :value="old('matricule')" required autofocus autocomplete="matricule" />
                                    @error('matricule')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="prenomMere" x-model="prenomMere" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="prenomMere" :value="old('prenomMere')" required autofocus autocomplete="prenomMere" />
                                    @error('prenomMere')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="nomMere" x-model="nomMere" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="nomMere" :value="old('nomMere')" required autofocus autocomplete="nomMere" />
                                    @error('nomMere')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="prenomPere" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="prenomPere" :value="old('prenomPere')" required autofocus autocomplete="prenomPere" />
                                    @error('prenomPere')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                        ...
                        <div x-show.transition.in="step === 2">
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="email" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="email" name="email" :value="old('email')" required autofocus autocomplete="email" />
                                    @error('email')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <x-input id="dateInsertion" x-model="dateInsertion" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="date" name="dateInsertion" :value="old('dateInsertion')" required autofocus autocomplete="dateInsertion" />
                                    @error('dateInsertion')
                                    <span class="text-xs text-red-500">
                                        {{$message}}
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <select id="autoEmploi" x-model="autoEmploi" name="autoEmploi" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " required autofocus>
                                ...
                                <div class="w-full sm:w-1/2 px-2 pb-5">
                                    ...
                                    <select id="emploiSalarie" x-model="emploiSalarie" name="emploiSalarie" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " required autofocus>
                                        <option value="">Choisir une option</option>
                                        <option value="1">Oui</option>
                                        <option value="0">Non</option>
                                    </select>
    ...
    <script>
        function app() {
            return {
                ...
                validNextStep(step) {
                    const regex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
                    inp1 = ['nom', 'prenom', 'date_naissance', 'lieu_naissance', 'commune_id', 'adresse', 'sexe', 'situationMatrimoniale', 'nomTuteur', 'prenomTuteur', 'numTelTuteur', 'prenomPere', 'nomPere', 'prenomMere', 'nomMere']
