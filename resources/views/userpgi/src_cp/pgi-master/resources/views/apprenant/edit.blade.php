                    ...
                    <div class="flex flex-wrap w-full justify-evenly">
                        ...
                        <div class="flex flex-wrap w-full justify-evenly">
                            ...
                            <div class="w-full sm:w-1/2 px-2 pb-5">
                                ...
                                <x-input id="matricule" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="matricule" value="{{ $apprenant->matricule }}" required autofocus autocomplete="matricule" />
                                @error('matricule')
                                <span class="text-xs text-red-500">
                                    {{$message}}
                        ...
                        <div class="flex flex-wrap w-full justify-evenly">
                            <div class="flex-grow mb-4 mr-2">
                                ...
                                <select id="nationalite" name="nationalite" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " required autofocus>
                                    ...
                                    <option value="{{ $nationalite->nationality }}"  @if($apprenant->nationalite === $nationalite->nationality ) selected @endif>{{ $nationalite->nationality}}</option>
                                    @endforeach
                                </select>
                                @error('nationalite')
                                <span class="text-xs text-red-500">
