        ...
        <div class="md:container md:mx-auto">
            ...
            <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                <div class="relative z-0 w-full mb-6 group">
                    <label for="prenom" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Prénom</label>
                    {!! Form::text('prenom', null, ['id' => 'prenom', 'class' => $inputClass, 'required' => '', 'placeholder' => 'Prénom']) !!}
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <label for="nom" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Nom</label>
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <label for="email" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Email</label>
                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    {!! Form::text('telephone', null, ['id' => 'telephone', 'class' => $inputClass, 'placeholder' => 'Numéro de téléphone']) !!}
                </div>


                <div class="relative z-0 w-full mb-6 group">
                    <label for="sexe" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Sexe</label>
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <label for="roles" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Profil</label>
                    {!! Form::select('roles[]',$roles, null, ['id' => 'roles', 'class' => $inputClass, 'required' => 'true',
                ...
                <div class="relative z-0 w-full mb-6 group" id="iasGroup" style="display: none;">
                    <label for="ias" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">IA</label>
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <label for="fonction" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">Fonction</label>
                    {!! Form::text('fonction', null, ['id' => 'fonction', 'class' => $inputClass, 'placeholder' => 'Fonction']) !!}
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <label for="" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">
                        Dernier diplôme académique
                    </label>
                    {!! Form::text('dernierDiplomeAcademique', null, ['id' => 'dernierDiplomeAcademique', 'class' => $inputClass, 'placeholder' => 'Dernier diplôme académique']) !!}
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <label for="" class="block mb-2 text-sm font-medium text-regal-black dark:text-regal-black">
                        Dernier diplôme professionnel
                    </label>
                    {!! Form::text('dernierDiplomeProfessionnel', null, ['id' => 'dernierDiplomeProfessionnel', 'class' => $inputClass, 'placeholder' => 'Dernier diplôme professionnel']) !!}
                </div>
