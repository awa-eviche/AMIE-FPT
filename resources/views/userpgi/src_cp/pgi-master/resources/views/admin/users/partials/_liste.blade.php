    ...
    <table class="w-full text-sm text-left text-gray-600 dark:text-gray-600">
        ...
        <tbody id="tableBody">
            ...
            <tr>
                ...
                <td @if(optioanl(optional(Auth()->user()->personnel)->etablissement)->id == null) colspan="8" @else colspan="7" @endif class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-gray-500 text-center hover:border-l-8 border-first-orange">
