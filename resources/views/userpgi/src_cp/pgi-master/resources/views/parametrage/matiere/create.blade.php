<x-app-layout>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            ...
            <a href="{{route('matiere.index')}}"  class="text-maquette">Référentiel</a>
              <span class="mx-2 text-maquette">/</span>
        <p> <a href="{{route('matiere.index')}}" >Matiére  </a>
            
            <span class="mx-2 text-maquette">/</span>
        </p>

        <p class="text-first-orange">Nouvelle Matiere</p>
        </p>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="{{ route('matiere.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                    Création d'une matiére
                </h3>
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="code" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="code" :value="old('code')" required autofocus autocomplete="code" />
                        @error('code')
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="coef" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="coef" :value="old('coef')" required autofocus autocomplete="coef" />
                        @error('coef')
                            <span class="text-xs text-red-500">
                                {{$message}}
                ...
                @livewire('parametrage.Matiere.CreateMatiere')
