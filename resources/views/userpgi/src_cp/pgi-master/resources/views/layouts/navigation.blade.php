        ...
        <div>
            ...
            @if(auth()->user()->can('gerer_parametrage') )
                <div x-data="{ open: {{ request()->is('referentiel*') ? 'true' : 'false' }} }">
                    ...
                    @can('visualiser_competencematiere_classe')
