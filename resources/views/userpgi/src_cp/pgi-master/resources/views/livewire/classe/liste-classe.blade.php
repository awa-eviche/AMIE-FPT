            ...
            <div class="rounded-lg shadow-md p-4 bg-white2 ">
                ...
                <div class="flex mb-4 items-center">
                    <div class="px-4 flex-1">
                        ...
                        <h3 class="text-sm py-1"><i class="text-green-600 fa fa-tag"></i>&nbsp;Année académique : <span class="font-bold">{{ $classe->annee_academique->annee1 . ' - ' . $classe->annee_academique->annee2  ?? ' - ' }}</span></h3>
                    </div>
