    ...
    <div class="grid grid-cols-2 md:grid-cols-2">
        <table class="table-auto w-full">
            ...
            <tbody>
                ...
                <tr>
                    <td class="px-4 py-2 border border-gray-300 text-center text-black">{{$donnee['filiere']['nom']}}</td>
                    <td class="px-4 py-2 border border-gray-300 text-center text-black">{{$donnee['niveau']['nom']}}</td>
