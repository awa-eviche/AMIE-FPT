<div>
    ...
    @if ($demande->documents->count()!= 0)
        <div class="flex justify-between p-3 mt-3">
            ...
            <div class="flex">
                ...
                @endif
                <button {{ $disabled ? 'disabled' : '' }}  wire:click="signer" class="flex items-center bg-green-800 hover:bg-green-900 hover:shadow-xl text-white font-bold px-3 py-2 rounded hover:shadow">
                    <span class="mr-2">
                        Signer
                    </span>
        ...
        <x-modal wire:model="timeToConfirme" :maxWidth="'2xl'">
            <div class="p-4">
                <div class="">
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette-gris">{{ Auth::user()->prenom }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette-gris">{{ Auth::user()->nom }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette-gris">{{ Auth::user()->email }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette-gris">{{  Auth::user()->telephone }}</span>
                        </div>
                    </div>
                ...
                <div class="flex justify-end mt-4">
                    ...
                    <button {{$disabled ? "disabled" : ''}} wire:click="signerUnDocument" class="ml-3 flex items-center cursor-pointer bg-green-800 hover:bg-green-900 hover:shadow-xl py-2 rounded px-3 text-center text-white">
                        <span class="mr-3">
   ...
   {{--     @if ($transactionSEncours->count() != 0)
            <div class="shadow-xl border border-gray-100 mb-5 p-3">
                <p class="text-first-orange font-bold">Vous avez des transaction en cours! Vous pouvez continuer la signature  </p>
                @foreach($transactionSEncours as $key=> $transaction)
                    <li class="flex items-center justify-between mb-2 bg-gray-100 w-[350px] m-3 p-3">
                        ...
                        <div class="flex items-center w-[250px] overflow-hidden">
                            ...
                            <span class="ml-3 w-[225px] overflow-hidden">{{$transaction->document->nom}}</span>
                        </div>
                        <div class="w-[60px] bg-blue-800 hover:bg-blue-900 hover:shadow-xl px-1 py-1 text-white rounded text-center">
                            <a class="text-white" href="{{$transaction->lien_signature}}" target="_blank">
                                Signer
                            </a>
                        </div>
                    </li>
        ...
        @if ($lienSignature != null)
            ...
            <a class="text-green-500 pl-4 cursor-pointer" href="{{$lienSignature}}">{{$lienSignature}}</a>
        @endif
            ...
            <ul class="list-disc pl-4 flex flex-wrap">
                ...
                @foreach($demande->documents as $key=> $document)
                    <li class="flex items-center justify-between mb-2 bg-gray-100 w-[350px] m-3 p-3">
                        @if ($readyToSign)
                            <div class="mr-2">
                                <input type="radio" name="idDocumentToSign" value="{{$document->id}}" id="{{$document->id}}" wire:model="idDocumentToSign">
                        ...
                        <div class="flex items-center w-[250px] overflow-hidden">
                            ...
                            <span class="ml-3 w-[225px] overflow-hidden">{{$document["nom"]}}</span>
                        </div>
