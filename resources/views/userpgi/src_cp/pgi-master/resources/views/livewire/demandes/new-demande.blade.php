...
<div x-data="app({{ $livewireStep }})" x-init="init()" x-cloak class="rounded-sm bg-white shadow-xl py-3 mx-4 px-4 mb-5">
        ...
        <div class="relative">
                    ...
                    <div class="bg-white rounded-lg p-10 flex items-center shadow justify-between">
                        <div class="lg:flex items-center w-full">
                            <div class="mr-4 mb-4 lg:mb-0 lg:w-1/2 p-5">
                                <img src="{{ asset('/assets/images/imageFin.png') }}" alt="Image" class="w-full">
                            </div>
                            <div class="lg:w-1/2">
                                <h2 class="font-black text-xl mb-2 text-first-orange uppercase">Votre demande est enregistrée avec succès</h2>
                                <p class="font-black mb-3 text-black">Durée de traitement prévu : XX jours </p>
                                <p class="font-thin text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi officia eaque molestiae quidem quo mollitia ipsum. A illum accusamus at? Aspernatur totam sapiente quam magni. Id magni et nisi blanditiis? Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloribus, natus quos ex nisi ab delectus dolorum repudiandae ullam. Cupiditate beatae recusandae reiciendis fugit debitis, veniam aperiam nulla. Velit, dolore distinctio..</p>

                                <div class="flex justify-end mt-4">
                                
                                   @if(Auth()->user())
				    <p>
                                        <a class="bg-first-orange rounded p-2 hover:bg-cyan-700 text-white font-bold text-sm" href="{{route("demande.index")}}">Voir toutes les demandes</a>
                                    </p>
                                   @endif
                                </div>
                ...
                <div x-show.transition="step != 6">
                        ...
                        <div class="w-full mx-auto mb-4 m-4 rounded">
                            ...
                            <div class="p-2 m-3">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="mb-4">
                                        <x-label for="prenom" class="font-semibold text-black">
                                            Prénom <span class="text-red-500">*</span>
                                        </x-label>
                                        <x-input wire:model="donnees.prenom" id="prenom" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 text-black" type="text" name="prenom" :value="old('prenom')" autofocus autocomplete="prenom" />
                                        @error('prenom')
                                    ...
                                    <div class="mb-4">
                                        <x-label for="nom" class="font-semibold text-black">
                                            Nom <span class="text-red-500">*</span>
                                        </x-label>
                                        <x-input wire:model="donnees.nom" id="nom" class="block text-black w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" type="text" name="nom" :value="old('nom')" autofocus autocomplete="nom" />
                                        @error('nom')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
                                        </span>
                                    ...
                                    <div class="mb-4">
                                        <x-label for="email" class="font-semibold text-black">
                                            Email <span class="text-red-500">*</span>
                                        </x-label>
                                        <x-input wire:model="donnees.email" id="email" class="block text-black w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" type="email" name="email" :value="old('email')" autocomplete="email" />
                                        @error('email')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
                                        </span>
                                    ...
                                    <div class="mb-4">
                                        <x-label for="adresse" value="{{ __('Adresse') }}" class="font-semibold text-black">
                                        Adresse <span class="text-red-500">*</span>
                                        </x-label>
                                        <x-input wire:model="donnees.adresse" id="adresse" class="text-black block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2" type="text" name="adresse" :value="old('adresse')" autofocus autocomplete="adresse" />
                                        @error('adresse')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
                                        </span>
                    ...
                    <div class="w-full h-full" x-show.transition="step == 2">
                        <div class="w-full mx-auto mb-4 rounded">
                            ...
                            <div class="p-2 m-3">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="mb-4">
                                        <x-label for="nom_etablissement" class="font-semibold text-black">
                                            Nom de l'établissement <span class="text-red-500">*</span>
                                        </x-label>
                                        <x-input wire:model="donnees.nom_etablissement" id="nom_etablissement" class="text-black block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="nom_etablissement" :value="old('nom_etablissement')" autocomplete="nom_etablissement" />
                                    ...
                                    <div class="mb-4">
                                        <x-label for="email_etablissement" class="font-semibold text-black">
                                            Email de l'établissement <span class="text-red-500">*</span>
                                        </x-label>
                                        <x-input wire:model="donnees.email_etablissement" id="email_etablissement" class="text-black block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="email_etablissement" :value="old('email_etablissement')" autofocus autocomplete="email_etablissement" />
                                    ...
                                    <div class="mb-4">
                                        <x-label for="commune_id" class="font-semibold text-black">
                                            Localisation <span class="text-red-500">*</span>
                                        </x-label>
                                        <select wire:model="donnees.commune_id" wire:change="onChangeCommune" wire:ignore class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="commune_id">
                                            <option value="">Choisir la localisation</option>
                                            @foreach($communes as $com)
                                            <option value="{{$com['id']}}" wire:key="{{ $com['id'] }}">{{ $com['libelle'] }}</option>
                                            @endforeach
                                        </select>
                                        @error('commune_id')
                                        <span class="text-xs text-red-500">
                                    ...
                                    <div class="mb-4">
                                        <x-label for="date_creation" class="font-semibold text-black">
                                            Date de création <span class="text-red-500">*</span>
                                        </x-label>
                                        <x-input wire:model="donnees.date_creation" id="date_creation" class="text-black block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="date" name="date_creation" :value="old('date_creation')" autofocus autocomplete="date_creation" />
                                        @error('date_creation')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
                                        </span>
                                    ...
                                    <div class="mb-4">
                                        <x-label for="statut_juridique" class="font-semibold text-black">
                                            Statut Juridique <span class="text-red-500">*</span>
                                        </x-label>
                                        <select wire:model="donnees.statut_juridique" wire:change="onChangeStatutJuridique" wire:ignore class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="niveau_id">
                                            <option value="">Choisir le statut juridique</option>
                                            @foreach($statutJuridiques as $sj)
                                            <option value="{{$sj['valeur']}}" wire:key="{{ $sj['id'] }}">{{ $sj['valeur'] }}</option>
                                            @endforeach
                                        </select> @error('statut_juridique')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
                                        </span>
                                        @enderror
                                    ...
                                    <div class="mb-4">
                                        <x-label for="type" class="font-semibold text-black">
                                        ...
                                        <select wire:model="donnees.type" wire:change="onChangeType" wire:ignore class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="type">
                                            ...
                                            <option value="{{$type['valeur']}}" wire:key="{{ $type['id'] }}">{{ $type['valeur'] }}</option>
                                            @endforeach
                                        </select> @error('type')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
                                    ...
                                    <div class="mb-4">
                                        <x-label for="statut" class="font-semibold text-black">
                                        ...
                                        <select wire:model="donnees.statut" wire:change="onChangeStatut" wire:ignore class="shadow appearance-none border-2 border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="statut">
                                            ...
                                            <option value="{{$statut['valeur']}}" wire:key="{{ $statut['id'] }}">{{ $statut['valeur'] }}</option>
                                            @endforeach
                                        </select> @error('statut')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
                            ...
                            <div class="p-2 m-3">
                                <div class="pb-4">
                                    <div class="flex flex-wrap place-content-around mx-auto">
                                        @if(($typeDemande)->code == config('constants.requests.D-OUVERTURE-ETABLISSEMENT') || ($typeDemande)->code == config('constants.requests.D-RECONNAISSANCE') || ($typeDemande)->code == config('constants.requests.D-EXTENSION-FILIERE'))
                                        <livewire:Param.DemandeOuvertureEtablissement :datasets="$gotDemande->projets ?? []" />
                                        @elseif(($typeDemande)->code == config('constants.requests.D-AUTORISATION-DIRIGER'))
                                        <livewire:Param.DemandeAutorisationDiriger :datasets="$gotDemande->projets ?? []"/>
                                        @elseif(($typeDemande)->code == config('constants.requests.D-QUALIFICATION-FILIERE'))
                                        <livewire:Param.DemandeQualificationFiliere :datasets="$gotDemande->projets ?? []" />
                                        @elseif(($typeDemande)->code == config('constants.requests.D-CHANGEMENT-DENOMINATION'))
                                        <livewire:Param.DemandeChangementDenomination :datasets="$gotDemande->projets ?? []" />
                                        @elseif(($typeDemande)->code == config('constants.requests.D-SUBVENTION'))
                                        <livewire:Param.DemandeSubvention :datasets="$gotDemande->projets ?? []" />
                                        @elseif(($typeDemande)->code == config('constants.requests.D-TRANSFERT-ETABLISSEMENT'))
                                        <livewire:Param.DemandeTransfertEtablissement :datasets="$gotDemande->projets ?? []" />
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white w-full h-full my-5 px-4 " x-show.transition="step == 4">
                        ...
                        <div class="flex flex-wrap place-content-around mx-auto rounded pb-5">
                            {{-- les documents pour le type de demande --}}

                            @foreach ($typeDemande->listes as $index => $typeDocument)
                            <div class="mt-4 flex">
                                <div>
                                    <x-label for="multiple_files{{$index}}" class="font-semibold text-black">
                                        {{$typeDocument->libelle}}
                                    </x-label>
                                    <div class="input_file_container">
                                        <input wire:model="fichiers.fichier_{{$index}}" class="styled_input_file" type="file" id="multiple_files{{$index}}" type="file" multiple>
                        ...
                        <div class="p-4 border rounded bg-white shadow">
                            ...
                            <ul class="list-disc pl-4 flex flex-wrap">
                                ...
                                @foreach($gotDemande->documents as $key=> $document)
                                ...
                                <table class="min-w-full border border-gray-300 text-sm rounded-lg">
                                    <thead class="border-maquette-gris">
                                        <tr class="flex">
                                            ...
                                            <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["email"]}}</td>
                                        </tr>
                                        <tr class="flex">
                                            <th class="w-1/3 flex items-center py-2 px-2 border-b text-black">Nom </th>
                                            <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["nom"]}}</td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="flex">
                                            <th class="w-1/3 flex items-center py-2 px-2 border-b text-black">Prénom</th>
                                            <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["prenom"]}}</td>
                                        </tr>
                                        <tr class="flex">
                                            <th class="w-1/3 flex items-center py-2 px-2 border-b text-black">Adresse</th>
                                            <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["adresse"]}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="max-w-7xl sm:px-2 lg:px-2 mx-3">
                                <table class="min-w-full border border-gray-300 text-sm rounded-lg">
                                    <tr class="flex">
                                        ...
                                        <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["nom_etablissement"]}}</td>
                                    </tr>
                                    ...
                                    <tr class="flex">
                                        ...
                                        <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["date_creation"]}}</td>
                                    </tr>
                                    <tr class="flex">
                                        <th class="w-1/3 flex items-center flex-start py-2 px-2 border-b text-black">Statut Juridique</th>
                                        <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["statut_juridique"]}}</td>
                                    </tr>
                                    <tr class="flex">
                                        <th class="w-1/3 flex items-center flex-start py-2 px-2 border-b text-black">Statut</th>
                                        <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["statut"]}}</td>
                                    </tr>
                                    <tr class="flex">
                                        <th class="w-1/3 flex items-center flex-start py-2 px-2 border-b text-black">Type</th>
                                        <td class="py-2 px-4 border-b w-2/3 border-l text-black">{{$donnees["type"]}}</td>
                                    </tr>
            ...
            <div class="px-4 flex justify-between">
                ...
                <div class="flex w-full justify-end">
                    ...
                    {{-- brouillon --}}
                    @if(Auth()->user())
                    <p {{-- @click="step++" --}} wire:click="enregistrerBrouillon" x-show="step == 5" class="cursor-pointer flex items-center bg-first-orange py-2 px-6 rounded text-white text-sm mr-2">
                    ...
                    @endif
                    {{-- soumettre --}}
                    <p {{-- @click="step++" --}} wire:click="soumettre" x-show="step == 5" {{ $isCharging ? 'disabled' : '' }} class="cursor-pointer flex items-center bg-cyan-700 hover:bg-green-800 py-2 px-6 rounded text-white text-sm text-bold">
