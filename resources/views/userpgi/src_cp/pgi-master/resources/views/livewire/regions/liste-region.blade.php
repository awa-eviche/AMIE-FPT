...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="{{route('region.create')}}" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    @forelse ($regions as $region)
                        <tr class="text-gray-700 ">
                            ...
                            <td class="px-6 py-3 border-b">{{ $region->code ?? ' - ' }}</td>
                
                            <td class="px-6 py-3 border-b">{{ $region->libelle ?? '-' }}</td>
                                ...
                                <div class="relative" x-data="{ open: false }" @click.away="open = false"
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('region.edit', $region->id) }}" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                    ...
                    {!! Form::close() !!}
                                ...
                                {{--  <div
                                    ...
                                    <form class="text-center"
                                        action="{{ route('region.destroy', $region->id) }}" method="POST">
