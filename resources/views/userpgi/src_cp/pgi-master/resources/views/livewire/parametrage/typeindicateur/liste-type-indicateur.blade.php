<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            <a href="" class="mx-2 px-5 rounded-md py-0 flex text-black text-xs font-bold text-center shadow-md bg-white items-center">
                ...
                <span class="mx-2">Exporter la liste</span>
            </a>
            <a href="#" data-modal-target="type-indicateur-modal" data-modal-toggle="type-indicateur-modal" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                </svg><span class="mx-2">Ajouter un type d'indicateur</span>
            </a>
        </div>
        ...
        <!-- Main modal -->
        <div id="type-indicateur-modal" tabindex="-1" aria-hidden="true" class="bg-black bg-opacity-25 hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="type-indicateur-modal">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                       @livewire('parametrage.typeindicateur.crate-type-indicateur')
                    </div>
            ...
            <table class="w-full border-t mb-3">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-4 text-white"style="width:25%">Code</th>
                        <th class="px-4 py-4 text-white"style="width:25%">Libelle</th>
                        <th class="px-4 py-4 text-white"style="width:25%">Description</th>
                        <!-- <th class="px-4 py-4">Description</th> -->
                        <!-- <th class="px-4 py-4">Effectif</th> -->
                        <th class="py-4 flex justify-end text-white"style="width:25%">Actions</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y ">
                    @forelse ( $typeindicateur as $type)
                        <tr class="text-gray-700 ">
                            <td class="px-4 py-3 border-b">{{ $type->code ?? ' - ' }}</td>
                            ...
                            <td class="px-4 py-3 border-b flex justify-center" style="position relative;left:1%;">
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            {{-- <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('typeIndicateur.show', $type->id) }}"
                                                    class="text-purple-600">Détail
                                                </a>
                                            </div> --}}
                                            <div class="border shadow-md py-2 text-center">
                                                <a data-modal-target="edit-type-indicateur-modal'{{$type->id}}'" data-modal-toggle="edit-type-indicateur-modal'{{$type->id}}'" href="#" class="text-purple-600" >
                                                    Modifier
                                                </a>
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="{{ route('typeIndicateur.destroy', $type->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <!-- Main modal -->
                                <div id="edit-type-indicateur-modal'{{$type->id}}'" tabindex="-1" aria-hidden="true" class="hidden w-auto bg-black bg-opacity-25 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-centermd:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <!-- Modal header -->
                                            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                                ...
                                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="edit-type-indicateur-modal'{{$type->id}}'">
                                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                                    </svg>
                                                    <span class="sr-only">Close modal</span>
                                            ...
                                            <!-- Modal body -->
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="bg-white pt-6 pb-8 mb-4" action="{{ route('typeIndicateur.update', $type->id ) }}" method="POST">
                                                   @method('PUT')
                                                    @csrf
                                                    ...
                                                    <div class="w-full sm:px-2 lg:px-4 ">
                                                        ...
                                                        <div class="border border-gray-200">
                                                                <h3 class="bg-gray-100 p-2 text-sm font-bold text-first-orange">
                                                                    Modification d'un nouveau type d'indicateur
                                                        ...
                                                        <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                                            <div class="mb-4">
                                                                ...
                                                                <input value="{{ $type->code }}" type="text"
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <input value="{{ $type->libelle }}" type="text"
                                                                    class="border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm"
                                                    ...
                                                    <div>
                                                        <div class="mb-4">
                                                            ...
                                                            <textarea class="border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm" id="description" name="description" required cols="30" rows="2">
                                                                {{ $type->description }}
                                                            </textarea>
                                ...
                                {{--  <div
                                    ...
                                    <a href="{{ route('typeindicateur.show', $type->id) }}"
                                        class="text-maquette-gris">
                                        <svg width="15" height="13" viewBox="0 0 18 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M1.57141 7.5C1.57141 7.5 4.37661 1.5 9.2857 1.5C14.1948 1.5 17 7.5 17 7.5C17 7.5 14.1948 13.5 9.2857 13.5C4.37661 13.5 1.57141 7.5 1.57141 7.5Z"
                                                stroke="#929EAE" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path
                                                d="M9.2857 9.21429C10.2325 9.21429 11 8.44677 11 7.5C11 6.55323 10.2325 5.78571 9.2857 5.78571C8.33892 5.78571 7.57141 6.55323 7.57141 7.5C7.57141 8.44677 8.33892 9.21429 9.2857 9.21429Z"
                                                stroke="#929EAE" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>

                                    </a>
                                    <a href="{{ route('typeindicateur.edit', $type->id) }}" class="text-purple-600">
                                        <svg width="13" height="13" viewBox="0 0 15 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M8 9.5058L5 10.0458L5.5 7.0058L11.23 1.2958C11.323 1.20207 11.4336 1.12768 11.5554 1.07691C11.6773 1.02614 11.808 1 11.94 1C12.072 1 12.2027 1.02614 12.3246 1.07691C12.4464 1.12768 12.557 1.20207 12.65 1.2958L13.71 2.3558C13.8037 2.44876 13.8781 2.55936 13.9289 2.68122C13.9797 2.80308 14.0058 2.93379 14.0058 3.0658C14.0058 3.19781 13.9797 3.32852 13.9289 3.45037C13.8781 3.57223 13.8037 3.68284 13.71 3.7758L8 9.5058Z"
                                                stroke="#929EAE" stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                                d="M12.5 10.0059V13.0059C12.5 13.2711 12.3946 13.5254 12.2071 13.713C12.0196 13.9005 11.7652 14.0059 11.5 14.0059H2C1.73478 14.0059 1.48043 13.9005 1.29289 13.713C1.10536 13.5254 1 13.2711 1 13.0059V3.50586C1 3.24064 1.10536 2.98629 1.29289 2.79875C1.48043 2.61122 1.73478 2.50586 2 2.50586H5"
                                                stroke="#929EAE" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
