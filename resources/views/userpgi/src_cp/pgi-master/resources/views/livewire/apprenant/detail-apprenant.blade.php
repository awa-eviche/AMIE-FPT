                        ...
                        <div class="flex-1 border border-gray-200">
                            <div class="p-5">
                                ...
                                <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                    ...
                                    <div class="mb-2 flex justify-between items-center">
                                        <label for="cummune_id" class="flex-1 block text-gray-700 text-sm font-bold mb-2">Commune :</label>
                                        <input readonly type="text" value="{{ old('cummune_id') ?? $apprenant->commune->nom}}" class="flex-1 border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm" id="commune_id" name="commune_id" >
                                ...
                                <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                    <div class="mb-2 flex justify-between items-center">
                                      ...
                                      <span  class="flex-1 border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm" id="autoEmploi"></span>  {{ $apprenant->autoEmploi == 1 ? "OUI" : "NON" }}

                                    </div>
                                    <div class="mb-2 flex justify-between items-center">
                                    <label for="emploiSalarie" class="flex-1 block text-gray-700 text-sm font-bold mb-2">Emploi Salarié :</label>
                                      <span  class="flex-1 border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm" id="emploiSalarie"></span>  {{ $apprenant->emploiSalarie == 1 ? "OUI" : "NON" }}
                                ...
                                <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                    ...
                                    <div class="mb-2 flex justify-between items-center ">
                                        ...
                                        <input readonly type="text" value="{{ $apprenant->commune->nom }}" class="flex-1 border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm" id="commune_id" name="commune_id" >
