    ...
    <div class="flex my-1 justify-between px-4">
        ...
        <div class="grid md:grid-cols-1 md:gap-6 pt-2">
            <div class="mb-4">
                ...
                <select wire:model="selectedRegion" wire:change="$refresh" id="selectRegion" class="border border-gray-300 p-3 w-full max-w-xs focus:border-first-orange enlever_shadow rounded px-8 py-0.75 shadow-first-orange text-sm font-bold">
