...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            @can('edit_etablisement')
            <a href="{{route('elementcompetence.create')}}" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter un element de competence</span>
    ...
    <label for="selectedElementCompetenceMetier" style="text-align: center;">Filtrer par métier :</label><br>
    <select name="metier_id" id="selectedElementCompetenceMetier" wire:model="selectedElementCompetenceMetier" wire:change="$refresh">
...
<div style="display: inline-block;">
    <label for="selectedElementCompetenceMatiere" style="text-align: center;">Filtrer par matière :</label><br>
    <select name="matiere_id" id="selectedElementCompetenceMatiere" wire:model="selectedElementCompetenceMatiere" wire:change="$refresh">
        ...
        <div class="text-sm w-full p-0">
            ...
            <thead>
                                    ...
                                    <th class="px-4 py-4">Code</th>
                                        ...
                                        <th class="px-4 py-4 text-white font-bold">Matiere</th>
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    @forelse ($elementcompetences as $elementcompetence)
                        <tr class="text-gray-700 ">
                            ...
                            <td class="px-4 py-3 border-b">{{ $elementcompetence->matiere->nom }}</td>
