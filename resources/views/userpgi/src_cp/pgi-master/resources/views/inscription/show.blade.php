                ...
                <div>
                    <div class="col text-gray-700 font-bold text-lg font-medium">
                        <a href="{{ route('inscription.index') }}">
                            ...
                            Retour à la liste des apprenants</span>
                        </a>
                    </div>
        ...
        <div class="flex md:w-full">
            <div class="rounded-lg border bg-gray shadow px-8 py-2 mr-2 bg-white sm:w-2/3 ">
                <div class="flex justify-between text-black items-center">
                    <span class="text-first-orange font-bold text-xl">Fiche détaillée de l'apprenant {{ $apprenant->nom }} {{ $apprenant->prenom }}</span>
            ...
            <div class="rounded-lg border shadow-sm px-8 py-2 sm:w-1/3 ">
                ...
                @foreach ($matieres as $mat)
                    <div class="border-b bg-gray-200 font-bold mb-1 p-2 text-sm">
                        <i class="fa fa-star text-xs me-1" style="color:#999"></i>
                        {{ $mat->nom }}
                        <!--i class="fa fa-close text-2xl float-end me-4" style="color:red"></i-->
                        <!--a href="{{ route('evaluation.create', [$inscription->id, $mat->id]) }}" class="text-success float-end me-4">
                   <i class="fas fa-pen text-xl" style="color: green;"></i>
                  </a-->
