      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
        <div class="p-6">
          <div class="flex justify-between items-start mb-5">
            ...
            <span class="flex items-center {{ $etablissement->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} text-xs font-medium px-3 py-1.5 rounded-full">
          ...
          <h2 class="text-xl font-bold text-[#1A4085] mb-4 truncate">{{ $etablissement->sigle }}</h2>
