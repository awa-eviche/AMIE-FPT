...
<div class="bg-transparent shadow rounded-sm w-full p-4">
  ...
  <a href="{{ route('users.index', ['etablissement' => $etablissement->id]) }}" class="w-max px-2 rounded-md py-1 flex items-center text-sm text-center bg-green-600  text-white }}">
