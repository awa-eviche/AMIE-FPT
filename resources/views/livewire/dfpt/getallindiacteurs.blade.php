<div>
    ...
    <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4"> 
        ...
        @foreach ($indicateurs as $indicateur)
            <a wire:click="getRealisations('{{ $indicateur->id }}','{{ $indicateur->label }}')" href="#" class="element_sidebar_acitf flex items-center justify-between p-2 rounded-md dark:bg-darker">
            <div>
