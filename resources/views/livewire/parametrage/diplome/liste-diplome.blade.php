...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="{{route('diplome.create')}}" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter un diplome</span>
    ...
    @if($count)
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded">{{ $count }} diplomes trouvés</span></div>
@endif
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    @forelse ($diplomes as $diplome)
                        <tr class="text-gray-700 ">
                            ...
                            <td class="px-6 py-3 border-b">{{ $diplome->code ?? ' - ' }}</td>
                
                            <td class="px-6 py-3 border-b">{{ $diplome->nom?? '-' }}</td>
                             <td class="px-6 py-3 border-b">{{ $diplome->description?? '-' }}</td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('diplome.show', $diplome->id) }}"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('diplome.edit', $diplome->id) }}" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
 @if(auth()->user()->hasRole(config('constants.roles.superadmin')))
                    ...
                    'route' => array('diplome.destroy', $diplome->id))) !!}
                    {{ csrf_field() }}
...
@endif
                                ...
                                {{--  <div
                                    ...
                                    <form class="text-center"
                                        action="{{ route('diplome.destroy', $diplome->id) }}" method="POST">
