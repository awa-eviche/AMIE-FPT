...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="{{route('secteur.create')}}" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                </svg><span class="mx-2">Ajouter un secteur</span>
    ...
    @if($count)
<div class="mb-2"><span class="bg-green-100 font-bold p-1 px-2 rounded">{{ $count }} secteurs trouvés</span></div>
@endif
        ...
        <div class="text-sm w-full p-0">
            <table class="w-full border-t mb-3">
                <thead>
                        ...
                        <th class="px-4 py-4 w-[60px] text-white font-normal">Actions</th>
                    </tr>
                </thead>
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    @forelse ($secteurs as $secteur)
                        ...
                        <td class="px-6 py-3 border-b">{{ $num }}</td>
                            <td class="px-6 py-3 border-b">{{ $secteur->code ?? ' - ' }}</td>
                
                            <td class="px-6 py-3 border-b">{{ $secteur->libelle ?? '-' }}</td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('secteur.show', $secteur->id) }}"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('secteur.edit', $secteur->id) }}" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
 @if(auth()->user()->hasRole(config('constants.roles.superadmin')))
                    ...
                    'route' => array('secteur.destroy', $secteur->id))) !!}
                    {{ csrf_field() }}
